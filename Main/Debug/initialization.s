...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0xd
	.string	"ALL_LEDS (LED_L_RD | LED_L_YE | LED_R_RD | LED_R_YE)"
	.byte	0x1
	.uleb128 0xf
	.string	"led_on(led) led_set(led, 1)"
	.byte	0x1
	.uleb128 0x10
	.string	"led_off(led) led_set(led, 0)"
	.byte	0x1
	.uleb128 0x15
	.string	"leds_on(ledMask) leds_set(ledMask, 1)"
	.byte	0x1
	.uleb128 0x16
	.string	"leds_off(ledMask) leds_set(ledMask, 0)"
	.byte	0x1
	.uleb128 0x18
	.string	"all_leds_on() leds_on(ALL_LEDS)"
	.byte	0x1
	.uleb128 0x19
	.string	"all_leds_off() leds_off(ALL_LEDS)"
	.byte	0x4
	.byte	0x3
	.uleb128 0xa
	.uleb128 0x16
	...
	.byte	0x1
	.uleb128 0xd
	.string	"SENS_LEFT_BACKWARD _BV(IO_SENS_BIT_LEFT1)"
	.byte	0x1
	.uleb128 0xe
	.string	"SENS_LEFT_FORWARD _BV(IO_SENS_BIT_LEFT2)"
	.byte	0x1
	.uleb128 0xf
	.string	"SENS_RIGHT_BACKWARD _BV(IO_SENS_BIT_RIGHT1)"
	.byte	0x1
	.uleb128 0x10
	.string	"SENS_RIGHT_FORWARD _BV(IO_SENS_BIT_RIGHT2)"
	.byte	0x4
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x17
...
__current_reset_status:
	.skip 1,0
	.section	.text.configure_hardware_and_signal_reset_condition_impl,"ax",@progbits
.global	configure_hardware_and_signal_reset_condition_impl
	.type	configure_hardware_and_signal_reset_condition_impl, @function
...
.LSM9:
	...
	ret
.LFE0:
	.size	configure_hardware_and_signal_reset_condition_impl, .-configure_hardware_and_signal_reset_condition_impl
	.section	.init8,"ax",@progbits
.global	configure_hardware_and_signal_reset_condition
	.type	configure_hardware_and_signal_reset_condition, @function
configure_hardware_and_signal_reset_condition:
.LFB1:
.LSM10:
/* prologue: naked */
/* frame size = 0 */
...
.L__stack_usage = 0
.LSM11:
	call configure_hardware_and_signal_reset_condition_impl
/* epilogue start */
.LSM12:
.LFE1:
	.size	configure_hardware_and_signal_reset_condition, .-configure_hardware_and_signal_reset_condition
...
.Letext0:
	...
	.long	0x11a
	.long	0x9c
	.string	"configure_hardware_and_signal_reset_condition_impl"
	.long	0xb0
	.string	"configure_hardware_and_signal_reset_condition"
	.long	0xc4
	.string	"blink_reset_condition"
	.long	0x107
	.string	"__current_reset_status"
	.long	0x0
...
.LASF13:
	.string	"configure_hardware_and_signal_reset_condition_impl"
.LASF18:
	.string	"E:\\\\Documents\\\\Dev\\\\NIBObee\\\\NIBObee\\\\NIBObee\\\\Debug"
.LASF9:
	.string	"LED_L_YE"
.LASF8:
