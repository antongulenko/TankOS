...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x18
	.string	"init_processes() _init_processes(0)"
	.byte	0x4
	.byte	0x1
	.uleb128 0xf
	.string	"init_process_timer() init_clock()"
	.byte	0x4
	.byte	0x3
	.uleb128 0xa
	.uleb128 0x17
...
.LSM1:
/* #APP */
 ;  14 "../processes/scheduler_base.c" 1
	push r0				
in r0, __SREG__		
cli					
push r0				
...
.LSM3:
/* #APP */
 ;  19 "../processes/scheduler_base.c" 1
	lds r26, __current_process
 ;  0 "" 2
.LSM4:
 ;  20 "../processes/scheduler_base.c" 1
	lds r27, __current_process + 1
 ;  0 "" 2
.LSM5:
 ;  21 "../processes/scheduler_base.c" 1
	in r0, __SP_L__			
st X+, r0					
in r0, __SP_H__			
st X+, r0					
...
.LSM7:
/* #APP */
 ;  25 "../processes/scheduler_base.c" 1
	movw r26, r24
 ;  0 "" 2
.LSM8:
 ;  26 "../processes/scheduler_base.c" 1
	ld r0, X+					
out __SP_L__, r0			
ld r0, X+					
out __SP_H__, r0			
 ...
 ;  0 "" 2
.LSM9:
 ;  27 "../processes/scheduler_base.c" 1
	pop r31			
pop r30			
pop r29			
pop r28			
...
pop r0						
 ...
 ;  0 "" 2
.LSM10:
 ;  30 "../processes/scheduler_base.c" 1
	reti
 ;  0 "" 2
/* epilogue start */
.LSM11:
...
.LSM18:
/* #APP */
 ;  44 "../processes/scheduler_base.c" 1
	sleep
 ;  0 "" 2
/* epilogue start */
.LSM19:
...
.LASLTP0:
	...
	.byte	0
	.byte	0x0
	.string	"scheduler_base.c"
	.uleb128 0x1
	.uleb128 0x0
	.uleb128 0x0
	.string	"scheduler_base.h"
	.uleb128 0x1
	.uleb128 0x0
	.uleb128 0x0
	.string	"../util/clock.h"
...
.LASF11:
	.string	"Process"
.LASF16:
	.string	"../processes/scheduler_base.c"
