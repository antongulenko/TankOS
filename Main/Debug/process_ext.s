...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x16
	.string	"init_processes_ext() _init_processes_ext(0)"
	.byte	0x4
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x15
	...
	.byte	0x1
	.uleb128 0x17
	.string	"ProcMem(proc) ((PPCBExt)getProcessMemory(proc))"
	.byte	0x1
	.uleb128 0x18
...
.LSM41:
	...
	std Z+2,r18
.LSM42:
	lds r18,__malloc_heap_end
	lds r19,__malloc_heap_end+1
	ldd r24,Y+1
	ldd r25,Y+2
	movw r30,r24
	std Z+5,r19
...
.Letext0:
	...
	.long	0x38b
	.long	0x106
	.string	"createProcessExt3"
	.long	0x17e
	.string	"createProcessExt2"
	.long	0x1b8
	.string	"createProcessExt"
	.long	0x1e4
	.string	"freeProcess"
	.long	0x21a
	...
	.long	0x2ac
	.string	"getProcessMemoryExt"
	.long	0x2d8
	.string	"_init_processes_ext"
	.long	0x378
...
.LASF23:
	.string	"createProcessExt"
.LASF38:
	.string	"../processes/process_ext.c"
.LASF31:
