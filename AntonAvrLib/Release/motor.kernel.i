# 1 "../kernel/devices/motor.kernel.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../kernel/devices/motor.kernel.c"
# 11 "../kernel/devices/motor.kernel.c"
...
# 24 "../kernel/devices/../../anton_std.h" 2
...
uint16_t getSpeed();
void setSpeed(PMotor motor, uint16_t speed);
void stopMotor(PMotor motor);
# 12 "../kernel/devices/motor.kernel.c" 2
