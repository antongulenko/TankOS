	.file	"commandQueueExecuter_loop.c"
__SREG__ = 0x3f
__SP_H__ = 0x3e
__SP_L__ = 0x3d
__CCP__ = 0x34
...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x2
	.string	"TWI_RPC_HASH_SERVER_COMMAND_QUEUE_H_ "
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x4
	.byte	0x1
...
/* #APP */
	__RAMPZ__ = 0x3b
/* #NOAPP */
	.section	.text.loopCommandQueue,"ax",@progbits
.global	loopCommandQueue
	.type	loopCommandQueue, @function
loopCommandQueue:
.LFB4:
.LSM0:
/* prologue: function */
...
.L6:
.LSM1:
	call invokeCommandQueueElement
	sbiw r24,0
	brne .L6
.LSM2:
	call inside_command_queue_loop
	rjmp .L6
.LFE4:
	.size	loopCommandQueue, .-loopCommandQueue
	.weak	inside_command_queue_loop
...
.LASLTP0:
	...
	.byte	0
	.byte	0x0
	.string	"commandQueueExecuter_loop.c"
	.uleb128 0x1
	.uleb128 0x0
	.uleb128 0x0
	.string	"commandQueueExecuter_loop.h"
	.uleb128 0x1
	.uleb128 0x0
	.uleb128 0x0
	.string	"twi_rpc_hash_server_commandQueue.h"
	.uleb128 0x1
	.uleb128 0x0
	.uleb128 0x0
	.string	"../../anton_std.h"
...
.LASF8:
	.string	"../kernel/TWI/commandQueueExecuter_loop.c"
.LASF1:
