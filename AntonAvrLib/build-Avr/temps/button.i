# 1 "AntonAvrLib/kernel/devices/button.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "AntonAvrLib/kernel/devices/button.c"
...
# 11 "AntonAvrLib/kernel/devices/button.h"
...
# 12 "AntonAvrLib/kernel/devices/button.h" 2
...
# 9 "AntonAvrLib/kernel/devices/button.c" 2

BOOL buttonStatus(PButton button) {
 BOOL val = readPin(button->pin);
 if (button->flags & (1 << (0))) val = !val;
 return val;
}
