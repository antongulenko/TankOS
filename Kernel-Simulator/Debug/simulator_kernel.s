...
.LSM10:
	ldi r26,lo8(PortA_)
	ldi r27,hi8(PortA_)
	ldi r30,lo8(C.10.2687)
	ldi r31,hi8(C.10.2687)
	ldi r24,lo8(6)
.L5:
	ld r0,Z+
	st X+,r0
...
.LSM11:
	ldi r26,lo8(PortB_)
	ldi r27,hi8(PortB_)
	ldi r30,lo8(C.11.2688)
	ldi r31,hi8(C.11.2688)
	ldi r24,lo8(6)
.L6:
	ld r0,Z+
	st X+,r0
...
.LSM12:
	ldi r26,lo8(PortC_)
	ldi r27,hi8(PortC_)
	ldi r30,lo8(C.12.2689)
	ldi r31,hi8(C.12.2689)
	ldi r24,lo8(6)
.L7:
	ld r0,Z+
	st X+,r0
...
.LSM13:
	ldi r26,lo8(PortD_)
	ldi r27,hi8(PortD_)
	ldi r30,lo8(C.13.2690)
	ldi r31,hi8(C.13.2690)
	ldi r24,lo8(6)
.L8:
	ld r0,Z+
	st X+,r0
...
.LSM18:
	ldi r26,lo8(Timer0_)
	ldi r27,hi8(Timer0_)
	ldi r30,lo8(C.6.2683)
	ldi r31,hi8(C.6.2683)
	ldi r24,lo8(7)
.L15:
	ld r0,Z+
	st X+,r0
...
.LSM19:
	ldi r26,lo8(Timer1_)
	ldi r27,hi8(Timer1_)
	ldi r30,lo8(C.7.2684)
	ldi r31,hi8(C.7.2684)
	ldi r24,lo8(7)
.L16:
	ld r0,Z+
	st X+,r0
...
.LSM20:
	ldi r26,lo8(Timer2_)
	ldi r27,hi8(Timer2_)
	ldi r30,lo8(C.8.2685)
	ldi r31,hi8(C.8.2685)
	ldi r24,lo8(7)
.L17:
	ld r0,Z+
	st X+,r0
...
.LSM21:
	ldi r26,lo8(Timer3_)
	ldi r27,hi8(Timer3_)
	ldi r30,lo8(C.9.2686)
	ldi r31,hi8(C.9.2686)
	ldi r24,lo8(7)
.L18:
	ld r0,Z+
	st X+,r0
...
C.6.2683:
	...
	.word	69
	.word	110
	.type	C.13.2690, @object
	.size	C.13.2690, 6
C.13.2690:
	.word	43
	.word	41
	.word	42
	.type	C.12.2689, @object
	.size	C.12.2689, 6
C.12.2689:
	.word	40
	.word	38
	.word	39
	.type	C.11.2688, @object
	.size	C.11.2688, 6
C.11.2688:
	.word	37
	.word	35
	.word	36
	.type	C.10.2687, @object
	.size	C.10.2687, 6
C.10.2687:
	.word	34
	.word	32
