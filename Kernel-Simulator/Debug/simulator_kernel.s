...
.LSM4:
	ldi r26,lo8(PortA)
	ldi r27,hi8(PortA)
	ldi r30,lo8(C.40.2867)
	ldi r31,hi8(C.40.2867)
	ldi r24,lo8(6)
.L3:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA0)
	ldi r27,hi8(PinA0)
	ldi r30,lo8(C.41.2868)
	ldi r31,hi8(C.41.2868)
	ldi r24,lo8(3)
.L4:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA1)
	ldi r27,hi8(PinA1)
	ldi r30,lo8(C.42.2869)
	ldi r31,hi8(C.42.2869)
	ldi r24,lo8(3)
.L5:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA2)
	ldi r27,hi8(PinA2)
	ldi r30,lo8(C.43.2870)
	ldi r31,hi8(C.43.2870)
	ldi r24,lo8(3)
.L6:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA3)
	ldi r27,hi8(PinA3)
	ldi r30,lo8(C.44.2871)
	ldi r31,hi8(C.44.2871)
	ldi r24,lo8(3)
.L7:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA4)
	ldi r27,hi8(PinA4)
	ldi r30,lo8(C.45.2872)
	ldi r31,hi8(C.45.2872)
	ldi r24,lo8(3)
.L8:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA5)
	ldi r27,hi8(PinA5)
	ldi r30,lo8(C.46.2873)
	ldi r31,hi8(C.46.2873)
	ldi r24,lo8(3)
.L9:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA6)
	ldi r27,hi8(PinA6)
	ldi r30,lo8(C.47.2874)
	ldi r31,hi8(C.47.2874)
	ldi r24,lo8(3)
.L10:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA7)
	ldi r27,hi8(PinA7)
	ldi r30,lo8(C.48.2875)
	ldi r31,hi8(C.48.2875)
	ldi r24,lo8(3)
.L11:
	ld r0,Z+
	st X+,r0
...
.LSM5:
	ldi r26,lo8(PortB)
	ldi r27,hi8(PortB)
	ldi r30,lo8(C.49.2876)
	ldi r31,hi8(C.49.2876)
	ldi r24,lo8(6)
.L12:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB0)
	ldi r27,hi8(PinB0)
	ldi r30,lo8(C.50.2877)
	ldi r31,hi8(C.50.2877)
	ldi r24,lo8(3)
.L13:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB1)
	ldi r27,hi8(PinB1)
	ldi r30,lo8(C.51.2878)
	ldi r31,hi8(C.51.2878)
	ldi r24,lo8(3)
.L14:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB2)
	ldi r27,hi8(PinB2)
	ldi r30,lo8(C.52.2879)
	ldi r31,hi8(C.52.2879)
	ldi r24,lo8(3)
.L15:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB3)
	ldi r27,hi8(PinB3)
	ldi r30,lo8(C.53.2880)
	ldi r31,hi8(C.53.2880)
	ldi r24,lo8(3)
.L16:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB4)
	ldi r27,hi8(PinB4)
	ldi r30,lo8(C.54.2881)
	ldi r31,hi8(C.54.2881)
	ldi r24,lo8(3)
.L17:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB5)
	ldi r27,hi8(PinB5)
	ldi r30,lo8(C.55.2882)
	ldi r31,hi8(C.55.2882)
	ldi r24,lo8(3)
.L18:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB6)
	ldi r27,hi8(PinB6)
	ldi r30,lo8(C.56.2883)
	ldi r31,hi8(C.56.2883)
	ldi r24,lo8(3)
.L19:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB7)
	ldi r27,hi8(PinB7)
	ldi r30,lo8(C.57.2884)
	ldi r31,hi8(C.57.2884)
	ldi r24,lo8(3)
.L20:
	ld r0,Z+
	st X+,r0
...
.LSM6:
	ldi r26,lo8(PortC)
	ldi r27,hi8(PortC)
	ldi r30,lo8(C.58.2885)
	ldi r31,hi8(C.58.2885)
	ldi r24,lo8(6)
.L21:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC0)
	ldi r27,hi8(PinC0)
	ldi r30,lo8(C.59.2886)
	ldi r31,hi8(C.59.2886)
	ldi r24,lo8(3)
.L22:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC1)
	ldi r27,hi8(PinC1)
	ldi r30,lo8(C.60.2887)
	ldi r31,hi8(C.60.2887)
	ldi r24,lo8(3)
.L23:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC2)
	ldi r27,hi8(PinC2)
	ldi r30,lo8(C.61.2888)
	ldi r31,hi8(C.61.2888)
	ldi r24,lo8(3)
.L24:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC3)
	ldi r27,hi8(PinC3)
	ldi r30,lo8(C.62.2889)
	ldi r31,hi8(C.62.2889)
	ldi r24,lo8(3)
.L25:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC4)
	ldi r27,hi8(PinC4)
	ldi r30,lo8(C.63.2890)
	ldi r31,hi8(C.63.2890)
	ldi r24,lo8(3)
.L26:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC5)
	ldi r27,hi8(PinC5)
	ldi r30,lo8(C.64.2891)
	ldi r31,hi8(C.64.2891)
	ldi r24,lo8(3)
.L27:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC6)
	ldi r27,hi8(PinC6)
	ldi r30,lo8(C.65.2892)
	ldi r31,hi8(C.65.2892)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC7)
	ldi r27,hi8(PinC7)
	ldi r30,lo8(C.66.2893)
	ldi r31,hi8(C.66.2893)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
...
.LSM7:
	ldi r26,lo8(PortD)
	ldi r27,hi8(PortD)
	ldi r30,lo8(C.67.2894)
	ldi r31,hi8(C.67.2894)
	ldi r24,lo8(6)
.L30:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD0)
	ldi r27,hi8(PinD0)
	ldi r30,lo8(C.68.2895)
	ldi r31,hi8(C.68.2895)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD1)
	ldi r27,hi8(PinD1)
	ldi r30,lo8(C.69.2896)
	ldi r31,hi8(C.69.2896)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD2)
	ldi r27,hi8(PinD2)
	ldi r30,lo8(C.70.2897)
	ldi r31,hi8(C.70.2897)
	ldi r24,lo8(3)
.L33:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD3)
	ldi r27,hi8(PinD3)
	ldi r30,lo8(C.71.2898)
	ldi r31,hi8(C.71.2898)
	ldi r24,lo8(3)
.L34:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD4)
	ldi r27,hi8(PinD4)
	ldi r30,lo8(C.72.2899)
	ldi r31,hi8(C.72.2899)
	ldi r24,lo8(3)
.L35:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD5)
	ldi r27,hi8(PinD5)
	ldi r30,lo8(C.73.2900)
	ldi r31,hi8(C.73.2900)
	ldi r24,lo8(3)
.L36:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD6)
	ldi r27,hi8(PinD6)
	ldi r30,lo8(C.74.2901)
	ldi r31,hi8(C.74.2901)
	ldi r24,lo8(3)
.L37:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD7)
	ldi r27,hi8(PinD7)
	ldi r30,lo8(C.75.2902)
	ldi r31,hi8(C.75.2902)
	ldi r24,lo8(3)
.L38:
	ld r0,Z+
	st X+,r0
...
.LSM12:
	ldi r26,lo8(Timer0)
	ldi r27,hi8(Timer0)
	ldi r30,lo8(C.28.2855)
	ldi r31,hi8(C.28.2855)
	ldi r24,lo8(7)
.L77:
	ld r0,Z+
	st X+,r0
...
.LSM13:
	ldi r26,lo8(Timer1)
	ldi r27,hi8(Timer1)
	ldi r30,lo8(C.29.2856)
	ldi r31,hi8(C.29.2856)
	ldi r24,lo8(7)
.L78:
	ld r0,Z+
	st X+,r0
...
.LSM14:
	ldi r26,lo8(Timer2)
	ldi r27,hi8(Timer2)
	ldi r30,lo8(C.30.2857)
	ldi r31,hi8(C.30.2857)
	ldi r24,lo8(7)
.L79:
	ld r0,Z+
	st X+,r0
...
.LSM15:
	ldi r26,lo8(Timer3)
	ldi r27,hi8(Timer3)
	ldi r30,lo8(C.31.2858)
	ldi r31,hi8(C.31.2858)
	ldi r24,lo8(7)
.L80:
	ld r0,Z+
	st X+,r0
...
.LSM16:
	ldi r26,lo8(Timer0A)
	ldi r27,hi8(Timer0A)
	ldi r30,lo8(C.32.2859)
	ldi r31,hi8(C.32.2859)
	ldi r24,lo8(8)
.L81:
	ld r0,Z+
	st X+,r0
...
.LSM17:
	ldi r26,lo8(Timer0B)
	ldi r27,hi8(Timer0B)
	ldi r30,lo8(C.33.2860)
	ldi r31,hi8(C.33.2860)
	ldi r24,lo8(8)
.L82:
	ld r0,Z+
	st X+,r0
...
.LSM18:
	ldi r26,lo8(Timer1A)
	ldi r27,hi8(Timer1A)
	ldi r30,lo8(C.34.2861)
	ldi r31,hi8(C.34.2861)
	ldi r24,lo8(8)
.L83:
	ld r0,Z+
	st X+,r0
...
.LSM19:
	ldi r26,lo8(Timer1B)
	ldi r27,hi8(Timer1B)
	ldi r30,lo8(C.35.2862)
	ldi r31,hi8(C.35.2862)
	ldi r24,lo8(8)
.L84:
	ld r0,Z+
	st X+,r0
...
.LSM20:
	ldi r26,lo8(Timer2A)
	ldi r27,hi8(Timer2A)
	ldi r30,lo8(C.36.2863)
	ldi r31,hi8(C.36.2863)
	ldi r24,lo8(8)
.L85:
	ld r0,Z+
	st X+,r0
...
.LSM21:
	ldi r26,lo8(Timer2B)
	ldi r27,hi8(Timer2B)
	ldi r30,lo8(C.37.2864)
	ldi r31,hi8(C.37.2864)
	ldi r24,lo8(8)
.L86:
	ld r0,Z+
	st X+,r0
...
.LSM22:
	ldi r26,lo8(Timer3A)
	ldi r27,hi8(Timer3A)
	ldi r30,lo8(C.38.2865)
	ldi r31,hi8(C.38.2865)
	ldi r24,lo8(8)
.L87:
	ld r0,Z+
	st X+,r0
...
.LSM23:
	ldi r26,lo8(Timer3B)
	ldi r27,hi8(Timer3B)
	ldi r30,lo8(C.39.2866)
	ldi r31,hi8(C.39.2866)
	ldi r24,lo8(8)
.L88:
	ld r0,Z+
	st X+,r0
...
C.28.2855:
	...
	.word	69
	.word	110
	.type	C.75.2902, @object
	.size	C.75.2902, 3
C.75.2902:
	.word	PortD
	.byte	-128
	.type	C.74.2901, @object
	.size	C.74.2901, 3
C.74.2901:
	.word	PortD
	.byte	64
	.type	C.73.2900, @object
	.size	C.73.2900, 3
C.73.2900:
	.word	PortD
	.byte	32
	.type	C.72.2899, @object
	.size	C.72.2899, 3
C.72.2899:
	.word	PortD
	.byte	16
	.type	C.71.2898, @object
	.size	C.71.2898, 3
C.71.2898:
	.word	PortD
	.byte	8
	.type	C.70.2897, @object
	.size	C.70.2897, 3
C.70.2897:
	.word	PortD
	.byte	4
	.type	C.69.2896, @object
	.size	C.69.2896, 3
C.69.2896:
	.word	PortD
	.byte	2
	.type	C.68.2895, @object
	.size	C.68.2895, 3
C.68.2895:
	.word	PortD
	.byte	1
	.type	C.67.2894, @object
	.size	C.67.2894, 6
C.67.2894:
	.word	43
	.word	41
	.word	42
	.type	C.66.2893, @object
	.size	C.66.2893, 3
C.66.2893:
	.word	PortC
	.byte	-128
	.type	C.65.2892, @object
	.size	C.65.2892, 3
C.65.2892:
	.word	PortC
	.byte	64
	.type	C.64.2891, @object
	.size	C.64.2891, 3
C.64.2891:
	.word	PortC
	.byte	32
	.type	C.63.2890, @object
	.size	C.63.2890, 3
C.63.2890:
	.word	PortC
	.byte	16
	.type	C.62.2889, @object
	.size	C.62.2889, 3
C.62.2889:
	.word	PortC
	.byte	8
	.type	C.61.2888, @object
	.size	C.61.2888, 3
C.61.2888:
	.word	PortC
	.byte	4
	.type	C.60.2887, @object
	.size	C.60.2887, 3
C.60.2887:
	.word	PortC
	.byte	2
	.type	C.59.2886, @object
	.size	C.59.2886, 3
C.59.2886:
	.word	PortC
	.byte	1
	.type	C.58.2885, @object
	.size	C.58.2885, 6
C.58.2885:
	.word	40
	.word	38
	.word	39
	.type	C.57.2884, @object
	.size	C.57.2884, 3
C.57.2884:
	.word	PortB
	.byte	-128
	.type	C.56.2883, @object
	.size	C.56.2883, 3
C.56.2883:
	.word	PortB
	.byte	64
	.type	C.55.2882, @object
	.size	C.55.2882, 3
C.55.2882:
	.word	PortB
	.byte	32
	.type	C.54.2881, @object
	.size	C.54.2881, 3
C.54.2881:
	.word	PortB
	.byte	16
	.type	C.53.2880, @object
	.size	C.53.2880, 3
C.53.2880:
	.word	PortB
	.byte	8
	.type	C.52.2879, @object
	.size	C.52.2879, 3
C.52.2879:
	.word	PortB
	.byte	4
	.type	C.51.2878, @object
	.size	C.51.2878, 3
C.51.2878:
	.word	PortB
	.byte	2
	.type	C.50.2877, @object
	.size	C.50.2877, 3
C.50.2877:
	.word	PortB
	.byte	1
	.type	C.49.2876, @object
	.size	C.49.2876, 6
C.49.2876:
	.word	37
	.word	35
	.word	36
	.type	C.48.2875, @object
	.size	C.48.2875, 3
C.48.2875:
	.word	PortA
	.byte	-128
	.type	C.47.2874, @object
	.size	C.47.2874, 3
C.47.2874:
	.word	PortA
	.byte	64
	.type	C.46.2873, @object
	.size	C.46.2873, 3
C.46.2873:
	.word	PortA
	.byte	32
	.type	C.45.2872, @object
	.size	C.45.2872, 3
C.45.2872:
	.word	PortA
	.byte	16
	.type	C.44.2871, @object
	.size	C.44.2871, 3
C.44.2871:
	.word	PortA
	.byte	8
	.type	C.43.2870, @object
	.size	C.43.2870, 3
C.43.2870:
	.word	PortA
	.byte	4
	.type	C.42.2869, @object
	.size	C.42.2869, 3
C.42.2869:
	.word	PortA
	.byte	2
	.type	C.41.2868, @object
	.size	C.41.2868, 3
C.41.2868:
	.word	PortA
	.byte	1
	.type	C.40.2867, @object
	.size	C.40.2867, 6
C.40.2867:
	.word	34
	.word	32
