...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x29
	.string	"_NIBOBEE_BASE_H_ "
	.byte	0x1
	.uleb128 0x4c
	.string	"NIBOBEE_ASSERT_VOLTAGE(x) ((uint16_t)(1248/x))"
	.byte	0x4
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x12
	...
	.byte	0x1
	.uleb128 0x2a
	.string	"_NIBOBEE_MOTPID_H_ "
	.byte	0x4
	.byte	0x1
	.uleb128 0x2e
	.string	"UNUSED_NIBOBEE_LIB_C_FILE "
	.byte	0x3
	.uleb128 0x2f
	.uleb128 0x14
	.byte	0x1
	.uleb128 0x30
	.string	"_NIBOBEE_CLOCK_H_ "
	.byte	0x4
	.byte	0x2
	.uleb128 0x30
	.string	"UNUSED_NIBOBEE_LIB_C_FILE"
	.byte	0x1
	.uleb128 0x33
	.string	"PWM_TIMER_IMSK TIMSK1"
	.byte	0x1
	.uleb128 0x38
	.string	"PWM_TIMER_IMSK_OIE _BV(TOIE1)"
	.byte	0x1
	.uleb128 0x3e
	.string	"MOTPID_CALL_CNT 147"
	.byte	0x1
	.uleb128 0x41
	.string	"MOTPID_FREQ 100"
	.byte	0x1
	.uleb128 0x43
	.string	"MOTPID_KP 5"
	.byte	0x1
	...
	.byte	0x4
	.text
	.type	motpid_calculate_single, @function
motpid_calculate_single:
.LFB7:
.LM1:
.LVL0:
	push r16
...
.LVL10:
	ret
.LFE7:
	.size	motpid_calculate_single, .-motpid_calculate_single
.global	motpid_reset
...
.LM26:
	...
	call __divmodhi4
	movw r28,r22
	sts motpid_left_speed+1,r23
	sts motpid_left_speed,r22
.LM27:
	...
	movw r22,r18
	call __divmodhi4
	sts motpid_left_speed2+1,r23
	sts motpid_left_speed2,r22
.LM28:
	lds r24,motpid_mode
	tst r24
	brne .+2
...
.LBB2:
.LM29:
	lds r18,motpid_left_value
	lds r19,motpid_left_value+1
.LVL14:
.LM30:
	cpi r24,lo8(4)
	brne .L11
.LM31:
	lds r20,odometry_left
	lds r21,odometry_left+1
.LVL15:
.LM32:
...
.L11:
.LM37:
	lds r14,motpid_dyndata_left+2
	lds r15,motpid_dyndata_left+2+1
	lds r20,motpid_dyndata_left+4
	lds r21,motpid_dyndata_left+4+1
	lds r24,motpid_dyndata_left
	lds r25,motpid_dyndata_left+1
	movw r22,r14
	movw r16,r28
	call motpid_calculate_single
.LVL18:
	sts motpid_dyndata_left+4+1,r25
	sts motpid_dyndata_left+4,r24
.LM38:
	sts motpid_dyndata_left+1,r15
	sts motpid_dyndata_left,r14
.LM39:
	sts motpid_dyndata_left+2+1,r29
	sts motpid_dyndata_left+2,r28
.LM40:
	ldi r22,lo8(16)
	ldi r23,hi8(16)
	call __divmodhi4
...
.LM44:
	...
	call __divmodhi4
	movw r28,r22
	sts motpid_right_speed+1,r23
	sts motpid_right_speed,r22
.LM45:
	...
	movw r22,r18
	call __divmodhi4
	sts motpid_right_speed2+1,r23
	sts motpid_right_speed2,r22
.LM46:
	lds r24,motpid_mode
	tst r24
	brne .+2
...
.LBB3:
.LM47:
	lds r18,motpid_right_value
	lds r19,motpid_right_value+1
.LVL21:
.LM48:
	cpi r24,lo8(4)
	brne .L16
.LM49:
	lds r20,odometry_right
	lds r21,odometry_right+1
.LVL22:
.LM50:
	lds r24,motpid_position_speed
	lds r25,motpid_position_speed+1
...
.L16:
.LM55:
	lds r14,motpid_dyndata_right+2
	lds r15,motpid_dyndata_right+2+1
	lds r20,motpid_dyndata_right+4
	lds r21,motpid_dyndata_right+4+1
	lds r24,motpid_dyndata_right
	lds r25,motpid_dyndata_right+1
	movw r22,r14
	movw r16,r28
	call motpid_calculate_single
.LVL25:
...
.LM56:
	sts motpid_dyndata_right+1,r15
	sts motpid_dyndata_right,r14
.LM57:
	sts motpid_dyndata_right+2+1,r29
	sts motpid_dyndata_right+2,r28
.LM58:
	ldi r22,lo8(16)
	ldi r23,hi8(16)
	call __divmodhi4
...
.LVL29:
.LM87:
	sts motpid_left_value+1,r29
	sts motpid_left_value,r28
.LM88:
	sts motpid_right_value+1,r17
	sts motpid_right_value,r16
/* epilogue start */
.LM89:
	pop r29
	pop r28
...
.LVL38:
.LM98:
	sts motpid_position_speed+1,r15
	sts motpid_position_speed,r14
.LM99:
	sts motpid_left_value+1,r29
	sts motpid_left_value,r28
.LM100:
...
.LLST19:
	...
	.string	"motpid_reset"
	.long	0x187
	.string	"motpid_change_mode"
	.long	0x1b0
	.string	"motpid_left_timer_int"
	.long	0x1f2
	.string	"motpid_right_timer_int"
	.long	0x234
	.string	"__vector_15"
	.long	0x270
	.string	"motpid_init"
	.long	0x284
	.string	"motpid_release"
	.long	0x298
	.string	"motpid_setSpeed"
	.long	0x2d0
	.string	"motpid_stop"
	.long	0x2f9
	.string	"motpid_setTarget"
	.long	0x344
	.string	"motpid_setTargetRel"
	.long	0x47e
	.string	"motpid_cnt"
	.long	0x4c4
	.string	"motpid_left_speed"
	.long	0x4d6
	.string	"motpid_right_speed"
	.long	0x4e8
	.string	"motpid_left_speed2"
	.long	0x4fa
	.string	"motpid_right_speed2"
	.long	0x50c
	.string	"motpid_position_speed"
	.long	0x51e
	.string	"motpid_left_value"
	.long	0x530
	.string	"motpid_right_value"
	.long	0x542
	.string	"motpid_left_cnt"
	.long	0x554
	.string	"motpid_right_cnt"
	.long	0x566
	.string	"motpid_mode"
	.long	0x0
...
.LASF32:
	.string	"left"
.LASF43:
	.string	"odometry_left"
.LASF12:
	.string	"NIBOBEE_MOTPWM_INITIALIZED"
.LASF21:
	.string	"motpid_change_mode"
.LASF49:
	.string	"motpid_position_speed"
.LASF14:
	.string	"MOTPID_MODE_OFF"
.LASF45:
	.string	"motpid_left_speed"
.LASF40:
	.string	"motpid_cnt"
.LASF0:
	.string	"int8_t"
.LASF13:
	.string	"NIBOBEE_I2C_INITIALIZED"
.LASF19:
	.string	"reading"
.LASF51:
	.string	"motpid_right_value"
...
.LASF23:
	.string	"temp"
.LASF11:
	.string	"NIBOBEE_ANALOG_INITIALIZED"
.LASF16:
	.string	"MOTPID_MODE_POS"
.LASF41:
	.string	"odometry_pid_left"
.LASF50:
	.string	"motpid_left_value"
.LASF53:
	.string	"motpid_dyndata_left"
.LASF48:
	.string	"motpid_right_speed2"
.LASF28:
	.string	"running"
.LASF58:
	.string	"../../../NIBObeeLib/src/nibobee/motpid.c"
.LASF6:
	.string	"unsigned int"
.LASF33:
	.string	"right"
...
.LASF37:
	.string	"speed"
.LASF59:
	.string	"C:\\\\Dev\\\\NIBObee\\\\NIBObee\\\\NIBObeeLib\\\\Debug"
.LASF9:
	.string	"long long int"
.LASF39:
	.string	"nibobee_initialization"
.LASF52:
	.string	"motpid_mode"
.LASF29:
	.string	"motpid_init"
...
.LASF2:
	.string	"signed char"
.LASF60:
	.string	"motpid_calculate_single"
.LASF42:
	.string	"odometry_pid_right"
