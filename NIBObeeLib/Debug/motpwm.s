...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x32
	.string	"PWM_TIMER_MAX 511"
	.byte	0x1
	.uleb128 0x34
	.string	"PWM_TIMER_CNT TCNT1"
	.byte	0x1
	.uleb128 0x35
	.string	"PWM_TIMER_CCRA TCCR1A"
	.byte	0x1
	.uleb128 0x36
	.ascii	"PWM_TIMER_CCRA_INIT _B"
	.string	"V(COM1A1) | _BV(COM1A0) | _BV(COM1B1) | _BV(COM1B0) | _BV(WGM11)"
	.byte	0x1
	.uleb128 0x37
	.string	"PWM_TIMER_CCRB TCCR1B"
	.byte	0x1
	.uleb128 0x38
	.string	"PWM_TIMER_CCRB_INIT _BV(CS10)"
	.byte	0x1
	.uleb128 0x39
	.string	"PWM_TIMER_OCRA OCR1A"
	.byte	0x1
	.uleb128 0x3a
	.string	"PWM_TIMER_OCRA_INIT 0"
	.byte	0x1
	.uleb128 0x3b
	.string	"PWM_TIMER_OCRB OCR1B"
	.byte	0x1
	.uleb128 0x3c
	.string	"PWM_TIMER_OCRB_INIT 0"
	.byte	0x1
	.uleb128 0x3e
	.string	"PWM_TIMER_IMSK TIMSK1"
	.byte	0x1
	.uleb128 0x42
	.string	"PWM_TIMER_IMSK_INIT 0"
	.byte	0x1
	.uleb128 0x43
	.string	"PWM_TIMER_IMSK_CMPA _BV(OCIE1A)"
	.byte	0x1
	.uleb128 0x44
	.string	"PWM_TIMER_IMSK_CMPB _BV(OCIE1B)"
	.byte	0x4
	.text
.global	motpwm_init
...
.LM25:
	...
	neg r22
	sbci r23,lo8(-1)
	sts motpwm_motor_l+1,r23
	sts motpwm_motor_l,r22
.LM26:
	sbis 43-32,6
	rjmp .L11
.LM27:
...
.LM41:
	...
	neg r22
	sbci r23,lo8(-1)
	sts motpwm_motor_r+1,r23
	sts motpwm_motor_r,r22
.LM42:
	sbic 43-32,7
	rjmp .L18
.L16:
...
.LLST2:
	...
	.string	"motpwm_stop"
	.long	0x13f
	.string	"motpwm_setLeft"
	.long	0x168
	.string	"motpwm_setRight"
	.long	0x191
	.string	"__vector_13"
	.long	0x1a6
	.string	"__vector_14"
	.long	0x1fc
	.string	"motpwm_motor_l"
	.long	0x20e
	.string	"motpwm_motor_r"
	.long	0x220
	.string	"motpwm_flags"
	.long	0x0
...
.LASF3:
	.string	"int16_t"
.LASF25:
	.string	"../../../NIBObeeLib/src/nibobee/motpwm.c"
.LASF26:
