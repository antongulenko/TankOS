...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x35
	.string	"delay_ms(ms) _delay_ms(ms)"
	.byte	0x1
	.uleb128 0x3b
	.string	"delay_us(us) _delay_us(us)"
	.byte	0x4
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x16
	...
	.byte	0x1
	.uleb128 0x2d
	.string	"LINE_EEPROM ((void *)0)"
	.byte	0x4
	.text
	.type	do_calibrateBlack, @function
do_calibrateBlack:
.LFB9:
.LM1:
.LVL0:
...
.LM7:
	...
	lsl r28
	rol r29
	subi r28,lo8(-(line_cal))
	sbci r29,hi8(-(line_cal))
.LM8:
	lsl r30
	rol r31
...
.LVL5:
	ret
.LFE9:
	.size	do_calibrateBlack, .-do_calibrateBlack
	.type	do_calibrateWhite, @function
do_calibrateWhite:
.LFB8:
.LM11:
.LVL6:
...
.LVL10:
	ret
.LFE8:
	.size	do_calibrateWhite, .-do_calibrateWhite
...
.LLST4:
	...
	.long	0x2c6
	.long	0x1d7
	.string	"line_writePersistent"
	.long	0x1eb
	.string	"line_readPersistent"
	.long	0x1ff
	.string	"line_init"
	.long	0x213
	.string	"line_get"
	.long	0x264
	.string	"line_calibrateWhite"
	.long	0x278
	.string	"line_calibrateBlack"
	.long	0x2b3
	.string	"line_cal"
	.long	0x0
...
.LASF3:
	.string	"int16_t"
.LASF42:
	.string	"../../../NIBObeeLib/src/nibobee/line.c"
.LASF43:
