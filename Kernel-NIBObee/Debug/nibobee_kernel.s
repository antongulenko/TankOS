...
.LM26:
	ldi r26,lo8(PortA_)
	ldi r27,hi8(PortA_)
	ldi r30,lo8(C.64.4084)
	ldi r31,hi8(C.64.4084)
	ldi r24,lo8(6)
.L13:
	ld r0,Z+
	st X+,r0
...
.LM27:
	ldi r26,lo8(PortB_)
	ldi r27,hi8(PortB_)
	ldi r30,lo8(C.65.4085)
	ldi r31,hi8(C.65.4085)
	ldi r24,lo8(6)
.L14:
	ld r0,Z+
	st X+,r0
...
.LM28:
	ldi r26,lo8(PortC_)
	ldi r27,hi8(PortC_)
	ldi r30,lo8(C.66.4086)
	ldi r31,hi8(C.66.4086)
	ldi r24,lo8(6)
.L15:
	ld r0,Z+
	st X+,r0
...
.LM29:
	ldi r26,lo8(PortD_)
	ldi r27,hi8(PortD_)
	ldi r30,lo8(C.67.4087)
	ldi r31,hi8(C.67.4087)
	ldi r24,lo8(6)
.L16:
	ld r0,Z+
	st X+,r0
...
.LM40:
	...
	ldi r30,lo8(C.59.4078)
	ldi r31,hi8(C.59.4078)
	ldi r24,lo8(3)
.L23:
	ld r0,Z+
	st X+,r0
...
.LM41:
	...
	ldi r30,lo8(C.60.4079)
	ldi r31,hi8(C.60.4079)
	ldi r24,lo8(3)
.L24:
	ld r0,Z+
	st X+,r0
...
.LM42:
	...
	ldi r30,lo8(C.61.4080)
	ldi r31,hi8(C.61.4080)
	ldi r24,lo8(3)
.L25:
	ld r0,Z+
	st X+,r0
...
.LM43:
	...
	ldi r30,lo8(C.62.4081)
	ldi r31,hi8(C.62.4081)
	ldi r24,lo8(3)
.L26:
	ld r0,Z+
	st X+,r0
...
.LM44:
	...
	ldi r30,lo8(C.63.4082)
	ldi r31,hi8(C.63.4082)
	ldi r24,lo8(3)
.L27:
	ld r0,Z+
	st X+,r0
...
.LM62:
	ldi r26,lo8(Timer0_)
	ldi r27,hi8(Timer0_)
	ldi r30,lo8(C.47.4058)
	ldi r31,hi8(C.47.4058)
	ldi r24,lo8(7)
.L40:
	ld r0,Z+
	st X+,r0
...
.LM63:
	ldi r26,lo8(Timer1_)
	ldi r27,hi8(Timer1_)
	ldi r30,lo8(C.48.4059)
	ldi r31,hi8(C.48.4059)
	ldi r24,lo8(7)
.L41:
	ld r0,Z+
	st X+,r0
...
.LM64:
	ldi r26,lo8(Timer2_)
	ldi r27,hi8(Timer2_)
	ldi r30,lo8(C.49.4060)
	ldi r31,hi8(C.49.4060)
	ldi r24,lo8(7)
.L42:
	ld r0,Z+
	st X+,r0
...
.LM65:
	ldi r26,lo8(Timer3_)
	ldi r27,hi8(Timer3_)
	ldi r30,lo8(C.50.4061)
	ldi r31,hi8(C.50.4061)
	ldi r24,lo8(7)
.L43:
	ld r0,Z+
	st X+,r0
...
C.47.4058:
	...
	.word	69
	.word	110
	.type	C.63.4082, @object
	.size	C.63.4082, 3
C.63.4082:
	.word	allLedsArray
	.byte	4
	.type	C.62.4081, @object
	.size	C.62.4081, 3
C.62.4081:
	.word	leftLedsArray
	.byte	2
	.type	C.61.4080, @object
	.size	C.61.4080, 3
C.61.4080:
	.word	rightLedsArray
	.byte	2
	.type	C.60.4079, @object
	.size	C.60.4079, 3
C.60.4079:
	.word	yellowLedsArray
	.byte	2
	.type	C.59.4078, @object
	.size	C.59.4078, 3
C.59.4078:
	.word	redLedsArray
	.byte	2
	.type	C.67.4087, @object
	.size	C.67.4087, 6
C.67.4087:
	.word	43
	.word	41
	.word	42
	.type	C.66.4086, @object
	.size	C.66.4086, 6
C.66.4086:
	.word	40
	.word	38
	.word	39
	.type	C.65.4085, @object
	.size	C.65.4085, 6
C.65.4085:
	.word	37
	.word	35
	.word	36
	.type	C.64.4084, @object
	.size	C.64.4084, 6
C.64.4084:
	.word	34
	.word	32
