...
.LM28:
	ldi r26,lo8(PortA)
	ldi r27,hi8(PortA)
	ldi r30,lo8(C.33.2969)
	ldi r31,hi8(C.33.2969)
	ldi r24,lo8(6)
.L15:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA0)
	ldi r27,hi8(PinA0)
	ldi r30,lo8(C.34.2970)
	ldi r31,hi8(C.34.2970)
	ldi r24,lo8(3)
.L16:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA1)
	ldi r27,hi8(PinA1)
	ldi r30,lo8(C.35.2971)
	ldi r31,hi8(C.35.2971)
	ldi r24,lo8(3)
.L17:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA2)
	ldi r27,hi8(PinA2)
	ldi r30,lo8(C.36.2972)
	ldi r31,hi8(C.36.2972)
	ldi r24,lo8(3)
.L18:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA3)
	ldi r27,hi8(PinA3)
	ldi r30,lo8(C.37.2973)
	ldi r31,hi8(C.37.2973)
	ldi r24,lo8(3)
.L19:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA4)
	ldi r27,hi8(PinA4)
	ldi r30,lo8(C.38.2974)
	ldi r31,hi8(C.38.2974)
	ldi r24,lo8(3)
.L20:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA5)
	ldi r27,hi8(PinA5)
	ldi r30,lo8(C.39.2975)
	ldi r31,hi8(C.39.2975)
	ldi r24,lo8(3)
.L21:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA6)
	ldi r27,hi8(PinA6)
	ldi r30,lo8(C.40.2976)
	ldi r31,hi8(C.40.2976)
	ldi r24,lo8(3)
.L22:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA7)
	ldi r27,hi8(PinA7)
	ldi r30,lo8(C.41.2977)
	ldi r31,hi8(C.41.2977)
	ldi r24,lo8(3)
.L23:
	ld r0,Z+
	st X+,r0
...
.LM29:
	ldi r26,lo8(PortB)
	ldi r27,hi8(PortB)
	ldi r30,lo8(C.42.2978)
	ldi r31,hi8(C.42.2978)
	ldi r24,lo8(6)
.L24:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB0)
	ldi r27,hi8(PinB0)
	ldi r30,lo8(C.43.2979)
	ldi r31,hi8(C.43.2979)
	ldi r24,lo8(3)
.L25:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB1)
	ldi r27,hi8(PinB1)
	ldi r30,lo8(C.44.2980)
	ldi r31,hi8(C.44.2980)
	ldi r24,lo8(3)
.L26:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB2)
	ldi r27,hi8(PinB2)
	ldi r30,lo8(C.45.2981)
	ldi r31,hi8(C.45.2981)
	ldi r24,lo8(3)
.L27:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB3)
	ldi r27,hi8(PinB3)
	ldi r30,lo8(C.46.2982)
	ldi r31,hi8(C.46.2982)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB4)
	ldi r27,hi8(PinB4)
	ldi r30,lo8(C.47.2983)
	ldi r31,hi8(C.47.2983)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB5)
	ldi r27,hi8(PinB5)
	ldi r30,lo8(C.48.2984)
	ldi r31,hi8(C.48.2984)
	ldi r24,lo8(3)
.L30:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB6)
	ldi r27,hi8(PinB6)
	ldi r30,lo8(C.49.2985)
	ldi r31,hi8(C.49.2985)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB7)
	ldi r27,hi8(PinB7)
	ldi r30,lo8(C.50.2986)
	ldi r31,hi8(C.50.2986)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
...
.LM30:
	ldi r26,lo8(PortC)
	ldi r27,hi8(PortC)
	ldi r30,lo8(C.51.2987)
	ldi r31,hi8(C.51.2987)
	ldi r24,lo8(6)
.L33:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC0)
	ldi r27,hi8(PinC0)
	ldi r30,lo8(C.52.2988)
	ldi r31,hi8(C.52.2988)
	ldi r24,lo8(3)
.L34:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC1)
	ldi r27,hi8(PinC1)
	ldi r30,lo8(C.53.2989)
	ldi r31,hi8(C.53.2989)
	ldi r24,lo8(3)
.L35:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC2)
	ldi r27,hi8(PinC2)
	ldi r30,lo8(C.54.2990)
	ldi r31,hi8(C.54.2990)
	ldi r24,lo8(3)
.L36:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC3)
	ldi r27,hi8(PinC3)
	ldi r30,lo8(C.55.2991)
	ldi r31,hi8(C.55.2991)
	ldi r24,lo8(3)
.L37:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC4)
	ldi r27,hi8(PinC4)
	ldi r30,lo8(C.56.2992)
	ldi r31,hi8(C.56.2992)
	ldi r24,lo8(3)
.L38:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC5)
	ldi r27,hi8(PinC5)
	ldi r30,lo8(C.57.2993)
	ldi r31,hi8(C.57.2993)
	ldi r24,lo8(3)
.L39:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC6)
	ldi r27,hi8(PinC6)
	ldi r30,lo8(C.58.2994)
	ldi r31,hi8(C.58.2994)
	ldi r24,lo8(3)
.L40:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC7)
	ldi r27,hi8(PinC7)
	ldi r30,lo8(C.59.2995)
	ldi r31,hi8(C.59.2995)
	ldi r24,lo8(3)
.L41:
	ld r0,Z+
	st X+,r0
...
.LM31:
	ldi r26,lo8(PortD)
	ldi r27,hi8(PortD)
	ldi r30,lo8(C.60.2996)
	ldi r31,hi8(C.60.2996)
	ldi r24,lo8(6)
.L42:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD0)
	ldi r27,hi8(PinD0)
	ldi r30,lo8(C.61.2997)
	ldi r31,hi8(C.61.2997)
	ldi r24,lo8(3)
.L43:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD1)
	ldi r27,hi8(PinD1)
	ldi r30,lo8(C.62.2998)
	ldi r31,hi8(C.62.2998)
	ldi r24,lo8(3)
.L44:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD2)
	ldi r27,hi8(PinD2)
	ldi r30,lo8(C.63.2999)
	ldi r31,hi8(C.63.2999)
	ldi r24,lo8(3)
.L45:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD3)
	ldi r27,hi8(PinD3)
	ldi r30,lo8(C.64.3000)
	ldi r31,hi8(C.64.3000)
	ldi r24,lo8(3)
.L46:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD4)
	ldi r27,hi8(PinD4)
	ldi r30,lo8(C.65.3001)
	ldi r31,hi8(C.65.3001)
	ldi r24,lo8(3)
.L47:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD5)
	ldi r27,hi8(PinD5)
	ldi r30,lo8(C.66.3002)
	ldi r31,hi8(C.66.3002)
	ldi r24,lo8(3)
.L48:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD6)
	ldi r27,hi8(PinD6)
	ldi r30,lo8(C.67.3003)
	ldi r31,hi8(C.67.3003)
	ldi r24,lo8(3)
.L49:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD7)
	ldi r27,hi8(PinD7)
	ldi r30,lo8(C.68.3004)
	ldi r31,hi8(C.68.3004)
	ldi r24,lo8(3)
.L50:
	ld r0,Z+
	st X+,r0
...
.LM42:
	ldi r26,lo8(RedLeds)
	ldi r27,hi8(RedLeds)
	ldi r30,lo8(C.28.2963)
	ldi r31,hi8(C.28.2963)
	ldi r24,lo8(3)
.L89:
	ld r0,Z+
	st X+,r0
...
.LM43:
	...
	ldi r30,lo8(C.29.2964)
	ldi r31,hi8(C.29.2964)
	ldi r24,lo8(3)
.L90:
	ld r0,Z+
	st X+,r0
...
.LM44:
	...
	ldi r30,lo8(C.30.2965)
	ldi r31,hi8(C.30.2965)
	ldi r24,lo8(3)
.L91:
	ld r0,Z+
	st X+,r0
...
.LM45:
	...
	ldi r30,lo8(C.31.2966)
	ldi r31,hi8(C.31.2966)
	ldi r24,lo8(3)
.L92:
	ld r0,Z+
	st X+,r0
...
.LM46:
	ldi r26,lo8(AllLeds)
	ldi r27,hi8(AllLeds)
	ldi r30,lo8(C.32.2967)
	ldi r31,hi8(C.32.2967)
	ldi r24,lo8(3)
.L93:
	ld r0,Z+
	st X+,r0
...
.LM58:
	...
	ldi r30,lo8(C.24.2951)
	ldi r31,hi8(C.24.2951)
	ldi r24,lo8(3)
.L104:
	ld r0,Z+
	st X+,r0
...
.LM59:
	...
	ldi r30,lo8(C.25.2952)
	ldi r31,hi8(C.25.2952)
	ldi r24,lo8(3)
.L105:
	ld r0,Z+
	st X+,r0
...
.LM60:
	...
	ldi r30,lo8(C.26.2953)
	ldi r31,hi8(C.26.2953)
	ldi r24,lo8(3)
.L106:
	ld r0,Z+
	st X+,r0
...
.LM61:
	...
	ldi r30,lo8(C.27.2954)
	ldi r31,hi8(C.27.2954)
	ldi r24,lo8(3)
.L107:
	ld r0,Z+
	st X+,r0
...
.LM64:
	ldi r26,lo8(Timer0)
	ldi r27,hi8(Timer0)
	ldi r30,lo8(C.12.2939)
	ldi r31,hi8(C.12.2939)
	ldi r24,lo8(7)
.L114:
	ld r0,Z+
	st X+,r0
...
.LM65:
	ldi r26,lo8(Timer1)
	ldi r27,hi8(Timer1)
	ldi r30,lo8(C.13.2940)
	ldi r31,hi8(C.13.2940)
	ldi r24,lo8(7)
.L115:
	ld r0,Z+
	st X+,r0
...
.LM66:
	ldi r26,lo8(Timer2)
	ldi r27,hi8(Timer2)
	ldi r30,lo8(C.14.2941)
	ldi r31,hi8(C.14.2941)
	ldi r24,lo8(7)
.L116:
	ld r0,Z+
	st X+,r0
...
.LM67:
	ldi r26,lo8(Timer3)
	ldi r27,hi8(Timer3)
	ldi r30,lo8(C.15.2942)
	ldi r31,hi8(C.15.2942)
	ldi r24,lo8(7)
.L117:
	ld r0,Z+
	st X+,r0
...
.LM68:
	ldi r26,lo8(Timer0A)
	ldi r27,hi8(Timer0A)
	ldi r30,lo8(C.16.2943)
	ldi r31,hi8(C.16.2943)
	ldi r24,lo8(8)
.L118:
	ld r0,Z+
	st X+,r0
...
.LM69:
	ldi r26,lo8(Timer0B)
	ldi r27,hi8(Timer0B)
	ldi r30,lo8(C.17.2944)
	ldi r31,hi8(C.17.2944)
	ldi r24,lo8(8)
.L119:
	ld r0,Z+
	st X+,r0
...
.LM70:
	ldi r26,lo8(Timer1A)
	ldi r27,hi8(Timer1A)
	ldi r30,lo8(C.18.2945)
	ldi r31,hi8(C.18.2945)
	ldi r24,lo8(8)
.L120:
	ld r0,Z+
	st X+,r0
...
.LM71:
	ldi r26,lo8(Timer1B)
	ldi r27,hi8(Timer1B)
	ldi r30,lo8(C.19.2946)
	ldi r31,hi8(C.19.2946)
	ldi r24,lo8(8)
.L121:
	ld r0,Z+
	st X+,r0
...
.LM72:
	ldi r26,lo8(Timer2A)
	ldi r27,hi8(Timer2A)
	ldi r30,lo8(C.20.2947)
	ldi r31,hi8(C.20.2947)
	ldi r24,lo8(8)
.L122:
	ld r0,Z+
	st X+,r0
...
.LM73:
	ldi r26,lo8(Timer2B)
	ldi r27,hi8(Timer2B)
	ldi r30,lo8(C.21.2948)
	ldi r31,hi8(C.21.2948)
	ldi r24,lo8(8)
.L123:
	ld r0,Z+
	st X+,r0
...
.LM74:
	ldi r26,lo8(Timer3A)
	ldi r27,hi8(Timer3A)
	ldi r30,lo8(C.22.2949)
	ldi r31,hi8(C.22.2949)
	ldi r24,lo8(8)
.L124:
	ld r0,Z+
	st X+,r0
...
.LM75:
	ldi r26,lo8(Timer3B)
	ldi r27,hi8(Timer3B)
	ldi r30,lo8(C.23.2950)
	ldi r31,hi8(C.23.2950)
	ldi r24,lo8(8)
.L125:
	ld r0,Z+
	st X+,r0
...
.LM87:
	...
	ldi r30,lo8(C.9.2933)
	ldi r31,hi8(C.9.2933)
	ldi r24,lo8(5)
.L142:
	ld r0,Z+
	st X+,r0
...
.LM88:
	...
	ldi r30,lo8(C.10.2934)
	ldi r31,hi8(C.10.2934)
	ldi r24,lo8(5)
.L143:
	ld r0,Z+
	st X+,r0
...
twi_defaultSlaveBuffer:
	...
	.type	C.10.2934, @object
	.size	C.10.2934, 5
C.10.2934:
	.byte	0
	.word	PinD7
	.word	Timer1B
	.type	C.9.2933, @object
	.size	C.9.2933, 5
C.9.2933:
	.byte	0
	.word	PinD6
	.word	Timer1A
	.type	C.23.2950, @object
	.size	C.23.2950, 8
C.23.2950:
	.word	Timer3
	.word	154
...
C.12.2939:
	...
	.word	69
	.word	110
	.type	C.27.2954, @object
	.size	C.27.2954, 3
C.27.2954:
	.byte	6
	.word	PinC6
	.type	C.26.2953, @object
	.size	C.26.2953, 3
C.26.2953:
	.byte	6
	.word	PinC7
	.type	C.25.2952, @object
	.size	C.25.2952, 3
C.25.2952:
	.byte	6
	.word	PinC4
	.type	C.24.2951, @object
	.size	C.24.2951, 3
C.24.2951:
	.byte	6
	.word	PinC5
	.type	C.32.2967, @object
	.size	C.32.2967, 3
C.32.2967:
	.word	allLedsArray
	.byte	4
	.type	C.31.2966, @object
	.size	C.31.2966, 3
C.31.2966:
	.word	leftLedsArray
	.byte	2
	.type	C.30.2965, @object
	.size	C.30.2965, 3
C.30.2965:
	.word	rightLedsArray
	.byte	2
	.type	C.29.2964, @object
	.size	C.29.2964, 3
C.29.2964:
	.word	yellowLedsArray
	.byte	2
	.type	C.28.2963, @object
	.size	C.28.2963, 3
C.28.2963:
	.word	redLedsArray
	.byte	2
	.type	C.68.3004, @object
	.size	C.68.3004, 3
C.68.3004:
	.word	PortD
	.byte	-128
	.type	C.67.3003, @object
	.size	C.67.3003, 3
C.67.3003:
	.word	PortD
	.byte	64
	.type	C.66.3002, @object
	.size	C.66.3002, 3
C.66.3002:
	.word	PortD
	.byte	32
	.type	C.65.3001, @object
	.size	C.65.3001, 3
C.65.3001:
	.word	PortD
	.byte	16
	.type	C.64.3000, @object
	.size	C.64.3000, 3
C.64.3000:
	.word	PortD
	.byte	8
	.type	C.63.2999, @object
	.size	C.63.2999, 3
C.63.2999:
	.word	PortD
	.byte	4
	.type	C.62.2998, @object
	.size	C.62.2998, 3
C.62.2998:
	.word	PortD
	.byte	2
	.type	C.61.2997, @object
	.size	C.61.2997, 3
C.61.2997:
	.word	PortD
	.byte	1
	.type	C.60.2996, @object
	.size	C.60.2996, 6
C.60.2996:
	.word	43
	.word	41
	.word	42
	.type	C.59.2995, @object
	.size	C.59.2995, 3
C.59.2995:
	.word	PortC
	.byte	-128
	.type	C.58.2994, @object
	.size	C.58.2994, 3
C.58.2994:
	.word	PortC
	.byte	64
	.type	C.57.2993, @object
	.size	C.57.2993, 3
C.57.2993:
	.word	PortC
	.byte	32
	.type	C.56.2992, @object
	.size	C.56.2992, 3
C.56.2992:
	.word	PortC
	.byte	16
	.type	C.55.2991, @object
	.size	C.55.2991, 3
C.55.2991:
	.word	PortC
	.byte	8
	.type	C.54.2990, @object
	.size	C.54.2990, 3
C.54.2990:
	.word	PortC
	.byte	4
	.type	C.53.2989, @object
	.size	C.53.2989, 3
C.53.2989:
	.word	PortC
	.byte	2
	.type	C.52.2988, @object
	.size	C.52.2988, 3
C.52.2988:
	.word	PortC
	.byte	1
	.type	C.51.2987, @object
	.size	C.51.2987, 6
C.51.2987:
	.word	40
	.word	38
	.word	39
	.type	C.50.2986, @object
	.size	C.50.2986, 3
C.50.2986:
	.word	PortB
	.byte	-128
	.type	C.49.2985, @object
	.size	C.49.2985, 3
C.49.2985:
	.word	PortB
	.byte	64
	.type	C.48.2984, @object
	.size	C.48.2984, 3
C.48.2984:
	.word	PortB
	.byte	32
	.type	C.47.2983, @object
	.size	C.47.2983, 3
C.47.2983:
	.word	PortB
	.byte	16
	.type	C.46.2982, @object
	.size	C.46.2982, 3
C.46.2982:
	.word	PortB
	.byte	8
	.type	C.45.2981, @object
	.size	C.45.2981, 3
C.45.2981:
	.word	PortB
	.byte	4
	.type	C.44.2980, @object
	.size	C.44.2980, 3
C.44.2980:
	.word	PortB
	.byte	2
	.type	C.43.2979, @object
	.size	C.43.2979, 3
C.43.2979:
	.word	PortB
	.byte	1
	.type	C.42.2978, @object
	.size	C.42.2978, 6
C.42.2978:
	.word	37
	.word	35
	.word	36
	.type	C.41.2977, @object
	.size	C.41.2977, 3
C.41.2977:
	.word	PortA
	.byte	-128
	.type	C.40.2976, @object
	.size	C.40.2976, 3
C.40.2976:
	.word	PortA
	.byte	64
	.type	C.39.2975, @object
	.size	C.39.2975, 3
C.39.2975:
	.word	PortA
	.byte	32
	.type	C.38.2974, @object
	.size	C.38.2974, 3
C.38.2974:
	.word	PortA
	.byte	16
	.type	C.37.2973, @object
	.size	C.37.2973, 3
C.37.2973:
	.word	PortA
	.byte	8
	.type	C.36.2972, @object
	.size	C.36.2972, 3
C.36.2972:
	.word	PortA
	.byte	4
	.type	C.35.2971, @object
	.size	C.35.2971, 3
C.35.2971:
	.word	PortA
	.byte	2
	.type	C.34.2970, @object
	.size	C.34.2970, 3
C.34.2970:
	.word	PortA
	.byte	1
	.type	C.33.2969, @object
	.size	C.33.2969, 6
C.33.2969:
	.word	34
	.word	32
