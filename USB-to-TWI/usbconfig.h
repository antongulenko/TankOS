 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       /* 0xe8, 0x03 */ /* VOTI's lab use PID */ 0xdf, 0x05 /* obdev's shared PID for HIDs */
 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 'n', 't', 'o', 'n', '.', 'g', 'u', 'l', 'e', 'n', 'k', 'o', '@', 'g', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', '-', 't', 'o', '-', 'T', 'W', 'I'
