...
// Optional registry for client-functions, mapping strings to function-pointers.
...
// Optionally, fill a dictionary mapping function names to function pointers (convenience)
...
#else
#define REGISTER_CLIENT_FUNCTION(ignored)
#endif
