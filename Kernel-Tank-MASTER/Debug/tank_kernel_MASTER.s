...
.Ltext0:
	...
	.ascii	"r) { (byte*) parameters, sizeof(ArgStruct) }; t"
	.string	"wi_rpc_oneway(TWI_DEVICE, operationByte, buf); WAIT_FOR_TWI(); }"
	.byte	0x1
	.uleb128 0x4e
...
.LM19:
	ldi r26,lo8(PortA_)
	ldi r27,hi8(PortA_)
	ldi r30,lo8(C.52.3896)
	ldi r31,hi8(C.52.3896)
	ldi r24,lo8(6)
.L8:
	ld r0,Z+
	st X+,r0
...
.LM20:
	ldi r26,lo8(PortB_)
	ldi r27,hi8(PortB_)
	ldi r30,lo8(C.53.3897)
	ldi r31,hi8(C.53.3897)
	ldi r24,lo8(6)
.L9:
	ld r0,Z+
	st X+,r0
...
.LM21:
	ldi r26,lo8(PortC_)
	ldi r27,hi8(PortC_)
	ldi r30,lo8(C.54.3898)
	ldi r31,hi8(C.54.3898)
	ldi r24,lo8(6)
.L10:
	ld r0,Z+
	st X+,r0
...
.LM22:
	ldi r26,lo8(PortD_)
	ldi r27,hi8(PortD_)
	ldi r30,lo8(C.55.3899)
	ldi r31,hi8(C.55.3899)
	ldi r24,lo8(6)
.L11:
	ld r0,Z+
	st X+,r0
...
.LM25:
	ldi r26,lo8(Timer0_)
	ldi r27,hi8(Timer0_)
	ldi r30,lo8(C.48.3892)
	ldi r31,hi8(C.48.3892)
	ldi r24,lo8(7)
.L18:
	ld r0,Z+
	st X+,r0
...
.LM26:
	ldi r26,lo8(Timer1_)
	ldi r27,hi8(Timer1_)
	ldi r30,lo8(C.49.3893)
	ldi r31,hi8(C.49.3893)
	ldi r24,lo8(7)
.L19:
	ld r0,Z+
	st X+,r0
...
.LM27:
	ldi r26,lo8(Timer2_)
	ldi r27,hi8(Timer2_)
	ldi r30,lo8(C.50.3894)
	ldi r31,hi8(C.50.3894)
	ldi r24,lo8(7)
.L20:
	ld r0,Z+
	st X+,r0
...
.LM28:
	ldi r26,lo8(Timer3_)
	ldi r27,hi8(Timer3_)
	ldi r30,lo8(C.51.3895)
	ldi r31,hi8(C.51.3895)
	ldi r24,lo8(7)
.L21:
	ld r0,Z+
	st X+,r0
...
C.48.3892:
	...
	.word	69
	.word	110
	.type	C.55.3899, @object
	.size	C.55.3899, 6
C.55.3899:
	.word	43
	.word	41
	.word	42
	.type	C.54.3898, @object
	.size	C.54.3898, 6
C.54.3898:
	.word	40
	.word	38
	.word	39
	.type	C.53.3897, @object
	.size	C.53.3897, 6
C.53.3897:
	.word	37
	.word	35
	.word	36
	.type	C.52.3896, @object
	.size	C.52.3896, 6
C.52.3896:
	.word	34
	.word	32
