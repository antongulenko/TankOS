...
.LM27:
	ldi r26,lo8(PortA)
	ldi r27,hi8(PortA)
	ldi r30,lo8(C.22.2939)
	ldi r31,hi8(C.22.2939)
	ldi r24,lo8(6)
.L15:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA0)
	ldi r27,hi8(PinA0)
	ldi r30,lo8(C.23.2940)
	ldi r31,hi8(C.23.2940)
	ldi r24,lo8(3)
.L16:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA1)
	ldi r27,hi8(PinA1)
	ldi r30,lo8(C.24.2941)
	ldi r31,hi8(C.24.2941)
	ldi r24,lo8(3)
.L17:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA2)
	ldi r27,hi8(PinA2)
	ldi r30,lo8(C.25.2942)
	ldi r31,hi8(C.25.2942)
	ldi r24,lo8(3)
.L18:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA3)
	ldi r27,hi8(PinA3)
	ldi r30,lo8(C.26.2943)
	ldi r31,hi8(C.26.2943)
	ldi r24,lo8(3)
.L19:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA4)
	ldi r27,hi8(PinA4)
	ldi r30,lo8(C.27.2944)
	ldi r31,hi8(C.27.2944)
	ldi r24,lo8(3)
.L20:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA5)
	ldi r27,hi8(PinA5)
	ldi r30,lo8(C.28.2945)
	ldi r31,hi8(C.28.2945)
	ldi r24,lo8(3)
.L21:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA6)
	ldi r27,hi8(PinA6)
	ldi r30,lo8(C.29.2946)
	ldi r31,hi8(C.29.2946)
	ldi r24,lo8(3)
.L22:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA7)
	ldi r27,hi8(PinA7)
	ldi r30,lo8(C.30.2947)
	ldi r31,hi8(C.30.2947)
	ldi r24,lo8(3)
.L23:
	ld r0,Z+
	st X+,r0
...
.LM28:
	ldi r26,lo8(PortB)
	ldi r27,hi8(PortB)
	ldi r30,lo8(C.31.2948)
	ldi r31,hi8(C.31.2948)
	ldi r24,lo8(6)
.L24:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB0)
	ldi r27,hi8(PinB0)
	ldi r30,lo8(C.32.2949)
	ldi r31,hi8(C.32.2949)
	ldi r24,lo8(3)
.L25:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB1)
	ldi r27,hi8(PinB1)
	ldi r30,lo8(C.33.2950)
	ldi r31,hi8(C.33.2950)
	ldi r24,lo8(3)
.L26:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB2)
	ldi r27,hi8(PinB2)
	ldi r30,lo8(C.34.2951)
	ldi r31,hi8(C.34.2951)
	ldi r24,lo8(3)
.L27:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB3)
	ldi r27,hi8(PinB3)
	ldi r30,lo8(C.35.2952)
	ldi r31,hi8(C.35.2952)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB4)
	ldi r27,hi8(PinB4)
	ldi r30,lo8(C.36.2953)
	ldi r31,hi8(C.36.2953)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB5)
	ldi r27,hi8(PinB5)
	ldi r30,lo8(C.37.2954)
	ldi r31,hi8(C.37.2954)
	ldi r24,lo8(3)
.L30:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB6)
	ldi r27,hi8(PinB6)
	ldi r30,lo8(C.38.2955)
	ldi r31,hi8(C.38.2955)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB7)
	ldi r27,hi8(PinB7)
	ldi r30,lo8(C.39.2956)
	ldi r31,hi8(C.39.2956)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
...
.LM29:
	ldi r26,lo8(PortC)
	ldi r27,hi8(PortC)
	ldi r30,lo8(C.40.2957)
	ldi r31,hi8(C.40.2957)
	ldi r24,lo8(6)
.L33:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC0)
	ldi r27,hi8(PinC0)
	ldi r30,lo8(C.41.2958)
	ldi r31,hi8(C.41.2958)
	ldi r24,lo8(3)
.L34:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC1)
	ldi r27,hi8(PinC1)
	ldi r30,lo8(C.42.2959)
	ldi r31,hi8(C.42.2959)
	ldi r24,lo8(3)
.L35:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC2)
	ldi r27,hi8(PinC2)
	ldi r30,lo8(C.43.2960)
	ldi r31,hi8(C.43.2960)
	ldi r24,lo8(3)
.L36:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC3)
	ldi r27,hi8(PinC3)
	ldi r30,lo8(C.44.2961)
	ldi r31,hi8(C.44.2961)
	ldi r24,lo8(3)
.L37:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC4)
	ldi r27,hi8(PinC4)
	ldi r30,lo8(C.45.2962)
	ldi r31,hi8(C.45.2962)
	ldi r24,lo8(3)
.L38:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC5)
	ldi r27,hi8(PinC5)
	ldi r30,lo8(C.46.2963)
	ldi r31,hi8(C.46.2963)
	ldi r24,lo8(3)
.L39:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC6)
	ldi r27,hi8(PinC6)
	ldi r30,lo8(C.47.2964)
	ldi r31,hi8(C.47.2964)
	ldi r24,lo8(3)
.L40:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC7)
	ldi r27,hi8(PinC7)
	ldi r30,lo8(C.48.2965)
	ldi r31,hi8(C.48.2965)
	ldi r24,lo8(3)
.L41:
	ld r0,Z+
	st X+,r0
...
.LM30:
	ldi r26,lo8(PortD)
	ldi r27,hi8(PortD)
	ldi r30,lo8(C.49.2966)
	ldi r31,hi8(C.49.2966)
	ldi r24,lo8(6)
.L42:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD0)
	ldi r27,hi8(PinD0)
	ldi r30,lo8(C.50.2967)
	ldi r31,hi8(C.50.2967)
	ldi r24,lo8(3)
.L43:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD1)
	ldi r27,hi8(PinD1)
	ldi r30,lo8(C.51.2968)
	ldi r31,hi8(C.51.2968)
	ldi r24,lo8(3)
.L44:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD2)
	ldi r27,hi8(PinD2)
	ldi r30,lo8(C.52.2969)
	ldi r31,hi8(C.52.2969)
	ldi r24,lo8(3)
.L45:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD3)
	ldi r27,hi8(PinD3)
	ldi r30,lo8(C.53.2970)
	ldi r31,hi8(C.53.2970)
	ldi r24,lo8(3)
.L46:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD4)
	ldi r27,hi8(PinD4)
	ldi r30,lo8(C.54.2971)
	ldi r31,hi8(C.54.2971)
	ldi r24,lo8(3)
.L47:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD5)
	ldi r27,hi8(PinD5)
	ldi r30,lo8(C.55.2972)
	ldi r31,hi8(C.55.2972)
	ldi r24,lo8(3)
.L48:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD6)
	ldi r27,hi8(PinD6)
	ldi r30,lo8(C.56.2973)
	ldi r31,hi8(C.56.2973)
	ldi r24,lo8(3)
.L49:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD7)
	ldi r27,hi8(PinD7)
	ldi r30,lo8(C.57.2974)
	ldi r31,hi8(C.57.2974)
	ldi r24,lo8(3)
.L50:
	ld r0,Z+
	st X+,r0
...
.LM33:
	ldi r26,lo8(Timer0)
	ldi r27,hi8(Timer0)
	ldi r30,lo8(C.10.2927)
	ldi r31,hi8(C.10.2927)
	ldi r24,lo8(7)
.L89:
	ld r0,Z+
	st X+,r0
...
.LM34:
	ldi r26,lo8(Timer1)
	ldi r27,hi8(Timer1)
	ldi r30,lo8(C.11.2928)
	ldi r31,hi8(C.11.2928)
	ldi r24,lo8(7)
.L90:
	ld r0,Z+
	st X+,r0
...
.LM35:
	ldi r26,lo8(Timer2)
	ldi r27,hi8(Timer2)
	ldi r30,lo8(C.12.2929)
	ldi r31,hi8(C.12.2929)
	ldi r24,lo8(7)
.L91:
	ld r0,Z+
	st X+,r0
...
.LM36:
	ldi r26,lo8(Timer3)
	ldi r27,hi8(Timer3)
	ldi r30,lo8(C.13.2930)
	ldi r31,hi8(C.13.2930)
	ldi r24,lo8(7)
.L92:
	ld r0,Z+
	st X+,r0
...
.LM37:
	ldi r26,lo8(Timer0A)
	ldi r27,hi8(Timer0A)
	ldi r30,lo8(C.14.2931)
	ldi r31,hi8(C.14.2931)
	ldi r24,lo8(8)
.L93:
	ld r0,Z+
	st X+,r0
...
.LM38:
	ldi r26,lo8(Timer0B)
	ldi r27,hi8(Timer0B)
	ldi r30,lo8(C.15.2932)
	ldi r31,hi8(C.15.2932)
	ldi r24,lo8(8)
.L94:
	ld r0,Z+
	st X+,r0
...
.LM39:
	ldi r26,lo8(Timer1A)
	ldi r27,hi8(Timer1A)
	ldi r30,lo8(C.16.2933)
	ldi r31,hi8(C.16.2933)
	ldi r24,lo8(8)
.L95:
	ld r0,Z+
	st X+,r0
...
.LM40:
	ldi r26,lo8(Timer1B)
	ldi r27,hi8(Timer1B)
	ldi r30,lo8(C.17.2934)
	ldi r31,hi8(C.17.2934)
	ldi r24,lo8(8)
.L96:
	ld r0,Z+
	st X+,r0
...
.LM41:
	ldi r26,lo8(Timer2A)
	ldi r27,hi8(Timer2A)
	ldi r30,lo8(C.18.2935)
	ldi r31,hi8(C.18.2935)
	ldi r24,lo8(8)
.L97:
	ld r0,Z+
	st X+,r0
...
.LM42:
	ldi r26,lo8(Timer2B)
	ldi r27,hi8(Timer2B)
	ldi r30,lo8(C.19.2936)
	ldi r31,hi8(C.19.2936)
	ldi r24,lo8(8)
.L98:
	ld r0,Z+
	st X+,r0
...
.LM43:
	ldi r26,lo8(Timer3A)
	ldi r27,hi8(Timer3A)
	ldi r30,lo8(C.20.2937)
	ldi r31,hi8(C.20.2937)
	ldi r24,lo8(8)
.L99:
	ld r0,Z+
	st X+,r0
...
.LM44:
	ldi r26,lo8(Timer3B)
	ldi r27,hi8(Timer3B)
	ldi r30,lo8(C.21.2938)
	ldi r31,hi8(C.21.2938)
	ldi r24,lo8(8)
.L100:
	ld r0,Z+
	st X+,r0
...
.LM56:
	...
	ldi r30,lo8(C.7.2921)
	ldi r31,hi8(C.7.2921)
	ldi r24,lo8(7)
.L117:
	ld r0,Z+
	st X+,r0
...
.LM57:
	...
	ldi r30,lo8(C.8.2922)
	ldi r31,hi8(C.8.2922)
	ldi r24,lo8(7)
.L118:
	ld r0,Z+
	st X+,r0
...
C.10.2927:
	...
	.word	69
	.word	110
	.type	C.57.2974, @object
	.size	C.57.2974, 3
C.57.2974:
	.word	PortD
	.byte	-128
	.type	C.56.2973, @object
	.size	C.56.2973, 3
C.56.2973:
	.word	PortD
	.byte	64
	.type	C.55.2972, @object
	.size	C.55.2972, 3
C.55.2972:
	.word	PortD
	.byte	32
	.type	C.54.2971, @object
	.size	C.54.2971, 3
C.54.2971:
	.word	PortD
	.byte	16
	.type	C.53.2970, @object
	.size	C.53.2970, 3
C.53.2970:
	.word	PortD
	.byte	8
	.type	C.52.2969, @object
	.size	C.52.2969, 3
C.52.2969:
	.word	PortD
	.byte	4
	.type	C.51.2968, @object
	.size	C.51.2968, 3
C.51.2968:
	.word	PortD
	.byte	2
	.type	C.50.2967, @object
	.size	C.50.2967, 3
C.50.2967:
	.word	PortD
	.byte	1
	.type	C.49.2966, @object
	.size	C.49.2966, 6
C.49.2966:
	.word	43
	.word	41
	.word	42
	.type	C.48.2965, @object
	.size	C.48.2965, 3
C.48.2965:
	.word	PortC
	.byte	-128
	.type	C.47.2964, @object
	.size	C.47.2964, 3
C.47.2964:
	.word	PortC
	.byte	64
	.type	C.46.2963, @object
	.size	C.46.2963, 3
C.46.2963:
	.word	PortC
	.byte	32
	.type	C.45.2962, @object
	.size	C.45.2962, 3
C.45.2962:
	.word	PortC
	.byte	16
	.type	C.44.2961, @object
	.size	C.44.2961, 3
C.44.2961:
	.word	PortC
	.byte	8
	.type	C.43.2960, @object
	.size	C.43.2960, 3
C.43.2960:
	.word	PortC
	.byte	4
	.type	C.42.2959, @object
	.size	C.42.2959, 3
C.42.2959:
	.word	PortC
	.byte	2
	.type	C.41.2958, @object
	.size	C.41.2958, 3
C.41.2958:
	.word	PortC
	.byte	1
	.type	C.40.2957, @object
	.size	C.40.2957, 6
C.40.2957:
	.word	40
	.word	38
	.word	39
	.type	C.39.2956, @object
	.size	C.39.2956, 3
C.39.2956:
	.word	PortB
	.byte	-128
	.type	C.38.2955, @object
	.size	C.38.2955, 3
C.38.2955:
	.word	PortB
	.byte	64
	.type	C.37.2954, @object
	.size	C.37.2954, 3
C.37.2954:
	.word	PortB
	.byte	32
	.type	C.36.2953, @object
	.size	C.36.2953, 3
C.36.2953:
	.word	PortB
	.byte	16
	.type	C.35.2952, @object
	.size	C.35.2952, 3
C.35.2952:
	.word	PortB
	.byte	8
	.type	C.34.2951, @object
	.size	C.34.2951, 3
C.34.2951:
	.word	PortB
	.byte	4
	.type	C.33.2950, @object
	.size	C.33.2950, 3
C.33.2950:
	.word	PortB
	.byte	2
	.type	C.32.2949, @object
	.size	C.32.2949, 3
C.32.2949:
	.word	PortB
	.byte	1
	.type	C.31.2948, @object
	.size	C.31.2948, 6
C.31.2948:
	.word	37
	.word	35
	.word	36
	.type	C.30.2947, @object
	.size	C.30.2947, 3
C.30.2947:
	.word	PortA
	.byte	-128
	.type	C.29.2946, @object
	.size	C.29.2946, 3
C.29.2946:
	.word	PortA
	.byte	64
	.type	C.28.2945, @object
	.size	C.28.2945, 3
C.28.2945:
	.word	PortA
	.byte	32
	.type	C.27.2944, @object
	.size	C.27.2944, 3
C.27.2944:
	.word	PortA
	.byte	16
	.type	C.26.2943, @object
	.size	C.26.2943, 3
C.26.2943:
	.word	PortA
	.byte	8
	.type	C.25.2942, @object
	.size	C.25.2942, 3
C.25.2942:
	.word	PortA
	.byte	4
	.type	C.24.2941, @object
	.size	C.24.2941, 3
C.24.2941:
	.word	PortA
	.byte	2
	.type	C.23.2940, @object
	.size	C.23.2940, 3
C.23.2940:
	.word	PortA
	.byte	1
	.type	C.22.2939, @object
	.size	C.22.2939, 6
C.22.2939:
	.word	34
	.word	32
