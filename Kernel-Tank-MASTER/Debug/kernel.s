...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x13
	.string	"MOTOR_MIN_VALUE 410"
	.byte	0x1
	.uleb128 0x14
	.string	"MOTOR_MAX_VALUE 922"
	.byte	0x4
	.byte	0x1
	.uleb128 0xc
	.string	"MOTOR_ADJUSTMENT_STEP 10"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x3c
	.byte	0x1
...
.LM86:
	...
	ldi r18,lo8(PinC4_)
	ldi r19,hi8(PinC4_)
	sts LeftMotorBase_+1+1,r19
	sts LeftMotorBase_+1,r18
	ldi r18,lo8(Timer1B_)
	ldi r19,hi8(Timer1B_)
	sts LeftMotorBase_+3+1,r19
	sts LeftMotorBase_+3,r18
	ldi r18,lo8(PinC5_)
	ldi r19,hi8(PinC5_)
	sts LeftMotorBase_+9+1,r19
	sts LeftMotorBase_+9,r18
	call initMotor2Pins
.LM87:
	...
	ldi r18,lo8(PinC2_)
	ldi r19,hi8(PinC2_)
	sts RightMotorBase_+1+1,r19
	sts RightMotorBase_+1,r18
	ldi r18,lo8(Timer1A_)
	ldi r19,hi8(Timer1A_)
	sts RightMotorBase_+3+1,r19
	sts RightMotorBase_+3,r18
	ldi r18,lo8(PinC3_)
	ldi r19,hi8(PinC3_)
	sts RightMotorBase_+9+1,r19
	sts RightMotorBase_+9,r18
	call initMotor2Pins
.LM88:
	ldi r24,lo8(410)
	ldi r25,hi8(410)
...
.LLST57:
	...
	.long	0x11bb
	.string	"tankIO_blinkByte"
	.long	0x11ee
	.string	"tankIO_flashAllLeds"
	.long	0x1221
	.string	"tankIO_flashLeds"
	.long	0x1254
	.string	"tankIO_flashLed"
	.long	0x1287
	.string	"tankIO_blinkAllLeds"
	.long	0x12ba
	.string	"tankIO_blinkLeds"
	.long	0x12ed
	.string	"tankIO_blinkLed"
	.long	0x1320
	.string	"tankIO_setLeds"
	.long	0x1353
	.string	"tankIO_disableLeds"
	.long	0x1387
	.string	"tankIO_enableLeds"
	.long	0x13bb
	.string	"tankIO_setLed"
	.long	0x13ee
	.string	"tankIO_disableLed"
	.long	0x1421
	.string	"tankIO_enableLed"
	.long	0x1454
	.string	"tankIO_reset"
	.long	0x1478
	...
	.string	"twi_rpc"
	.long	0x16fb
	.string	"tankIO_pressedButtons"
	.long	0x173c
	.string	"tankIO_buttonStatus"
	.long	0x177d
	.string	"tankIO_isInitialized"
	.long	0x17be
	.string	"tankIO_wait"
	.long	0x1813
