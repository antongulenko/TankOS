...
void init_test_tank_arm() {
    ...
    tank_joint.front = newHallSensor(PORT_PIN_CHANGE, FRONT_PIN_CHANGE, testPin4, hall_flags);
    tank_joint.back = newHallSensor(PORT_PIN_CHANGE, BACK_PIN_CHANGE, testPin5, hall_flags);
    tank_joint.encoder = newEncoder(PORT_PIN_CHANGE, ENC_A_PIN_CHANGE, ENC_B_PIN_CHANGE, testPin6, testPin7, 0);
