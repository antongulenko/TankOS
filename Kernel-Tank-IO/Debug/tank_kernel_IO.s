...
.Ltext0:
	...
	.ascii	"dler, {0} }; void funcName ##_re"
	.string	"gister_function() { } KERNEL_INIT(funcName ##_register_function)"
	.byte	0x1
	.uleb128 0x32
...
.LM36:
	ldi r26,lo8(PortA_)
	ldi r27,hi8(PortA_)
	ldi r30,lo8(C.87.4122)
	ldi r31,hi8(C.87.4122)
	ldi r24,lo8(6)
.L18:
	ld r0,Z+
	st X+,r0
...
.LM37:
	ldi r26,lo8(PortB_)
	ldi r27,hi8(PortB_)
	ldi r30,lo8(C.88.4123)
	ldi r31,hi8(C.88.4123)
	ldi r24,lo8(6)
.L19:
	ld r0,Z+
	st X+,r0
...
.LM38:
	ldi r26,lo8(PortC_)
	ldi r27,hi8(PortC_)
	ldi r30,lo8(C.89.4124)
	ldi r31,hi8(C.89.4124)
	ldi r24,lo8(6)
.L20:
	ld r0,Z+
	st X+,r0
...
.LM39:
	ldi r26,lo8(PortD_)
	ldi r27,hi8(PortD_)
	ldi r30,lo8(C.90.4125)
	ldi r31,hi8(C.90.4125)
	ldi r24,lo8(6)
.L21:
	ld r0,Z+
	st X+,r0
...
.LM72:
	...
	ldi r30,lo8(C.81.4115)
	ldi r31,hi8(C.81.4115)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
...
.LM73:
	...
	ldi r30,lo8(C.82.4116)
	ldi r31,hi8(C.82.4116)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
...
.LM74:
	...
	ldi r30,lo8(C.83.4117)
	ldi r31,hi8(C.83.4117)
	ldi r24,lo8(3)
.L30:
	ld r0,Z+
	st X+,r0
...
.LM75:
	...
	ldi r30,lo8(C.84.4118)
	ldi r31,hi8(C.84.4118)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
...
.LM76:
	...
	ldi r30,lo8(C.85.4119)
	ldi r31,hi8(C.85.4119)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
...
.LM77:
	...
	ldi r30,lo8(C.86.4120)
	ldi r31,hi8(C.86.4120)
	ldi r24,lo8(3)
.L33:
	ld r0,Z+
	st X+,r0
...
.LM96:
	ldi r26,lo8(Timer0_)
	ldi r27,hi8(Timer0_)
	ldi r30,lo8(C.21.4023)
	ldi r31,hi8(C.21.4023)
	ldi r24,lo8(7)
.L47:
	ld r0,Z+
	st X+,r0
...
.LM97:
	ldi r26,lo8(Timer1_)
	ldi r27,hi8(Timer1_)
	ldi r30,lo8(C.22.4024)
	ldi r31,hi8(C.22.4024)
	ldi r24,lo8(7)
.L48:
	ld r0,Z+
	st X+,r0
...
.LM98:
	ldi r26,lo8(Timer2_)
	ldi r27,hi8(Timer2_)
	ldi r30,lo8(C.23.4025)
	ldi r31,hi8(C.23.4025)
	ldi r24,lo8(7)
.L49:
	ld r0,Z+
	st X+,r0
...
.LM99:
	ldi r26,lo8(Timer3_)
	ldi r27,hi8(Timer3_)
	ldi r30,lo8(C.24.4026)
	ldi r31,hi8(C.24.4026)
	ldi r24,lo8(7)
.L50:
	ld r0,Z+
	st X+,r0
...
C.21.4023:
	...
	.word	69
	.word	110
	.type	C.86.4120, @object
	.size	C.86.4120, 3
C.86.4120:
	.word	allLedsArray
	.byte	15
	.type	C.85.4119, @object
	.size	C.85.4119, 3
C.85.4119:
	.word	middleLedsArray
	.byte	5
	.type	C.84.4118, @object
	.size	C.84.4118, 3
C.84.4118:
	.word	greenLedsArray
	.byte	3
	.type	C.83.4117, @object
	.size	C.83.4117, 3
C.83.4117:
	.word	whiteLedsArray
	.byte	5
	.type	C.82.4116, @object
	.size	C.82.4116, 3
C.82.4116:
	.word	yellowLedsArray
	.byte	2
	.type	C.81.4115, @object
	.size	C.81.4115, 3
C.81.4115:
	.word	redLedsArray
	.byte	5
	.type	C.90.4125, @object
	.size	C.90.4125, 6
C.90.4125:
	.word	43
	.word	41
	.word	42
	.type	C.89.4124, @object
	.size	C.89.4124, 6
C.89.4124:
	.word	40
	.word	38
	.word	39
	.type	C.88.4123, @object
	.size	C.88.4123, 6
C.88.4123:
	.word	37
	.word	35
	.word	36
	.type	C.87.4122, @object
	.size	C.87.4122, 6
C.87.4122:
	.word	34
	.word	32
