...
.LM27:
	ldi r26,lo8(PortA)
	ldi r27,hi8(PortA)
	ldi r30,lo8(C.25.3016)
	ldi r31,hi8(C.25.3016)
	ldi r24,lo8(6)
.L15:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA0)
	ldi r27,hi8(PinA0)
	ldi r30,lo8(C.26.3017)
	ldi r31,hi8(C.26.3017)
	ldi r24,lo8(3)
.L16:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA1)
	ldi r27,hi8(PinA1)
	ldi r30,lo8(C.27.3018)
	ldi r31,hi8(C.27.3018)
	ldi r24,lo8(3)
.L17:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA2)
	ldi r27,hi8(PinA2)
	ldi r30,lo8(C.28.3019)
	ldi r31,hi8(C.28.3019)
	ldi r24,lo8(3)
.L18:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA3)
	ldi r27,hi8(PinA3)
	ldi r30,lo8(C.29.3020)
	ldi r31,hi8(C.29.3020)
	ldi r24,lo8(3)
.L19:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA4)
	ldi r27,hi8(PinA4)
	ldi r30,lo8(C.30.3021)
	ldi r31,hi8(C.30.3021)
	ldi r24,lo8(3)
.L20:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA5)
	ldi r27,hi8(PinA5)
	ldi r30,lo8(C.31.3022)
	ldi r31,hi8(C.31.3022)
	ldi r24,lo8(3)
.L21:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA6)
	ldi r27,hi8(PinA6)
	ldi r30,lo8(C.32.3023)
	ldi r31,hi8(C.32.3023)
	ldi r24,lo8(3)
.L22:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinA7)
	ldi r27,hi8(PinA7)
	ldi r30,lo8(C.33.3024)
	ldi r31,hi8(C.33.3024)
	ldi r24,lo8(3)
.L23:
	ld r0,Z+
	st X+,r0
...
.LM28:
	ldi r26,lo8(PortB)
	ldi r27,hi8(PortB)
	ldi r30,lo8(C.34.3025)
	ldi r31,hi8(C.34.3025)
	ldi r24,lo8(6)
.L24:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB0)
	ldi r27,hi8(PinB0)
	ldi r30,lo8(C.35.3026)
	ldi r31,hi8(C.35.3026)
	ldi r24,lo8(3)
.L25:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB1)
	ldi r27,hi8(PinB1)
	ldi r30,lo8(C.36.3027)
	ldi r31,hi8(C.36.3027)
	ldi r24,lo8(3)
.L26:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB2)
	ldi r27,hi8(PinB2)
	ldi r30,lo8(C.37.3028)
	ldi r31,hi8(C.37.3028)
	ldi r24,lo8(3)
.L27:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB3)
	ldi r27,hi8(PinB3)
	ldi r30,lo8(C.38.3029)
	ldi r31,hi8(C.38.3029)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB4)
	ldi r27,hi8(PinB4)
	ldi r30,lo8(C.39.3030)
	ldi r31,hi8(C.39.3030)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB5)
	ldi r27,hi8(PinB5)
	ldi r30,lo8(C.40.3031)
	ldi r31,hi8(C.40.3031)
	ldi r24,lo8(3)
.L30:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB6)
	ldi r27,hi8(PinB6)
	ldi r30,lo8(C.41.3032)
	ldi r31,hi8(C.41.3032)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinB7)
	ldi r27,hi8(PinB7)
	ldi r30,lo8(C.42.3033)
	ldi r31,hi8(C.42.3033)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
...
.LM29:
	ldi r26,lo8(PortC)
	ldi r27,hi8(PortC)
	ldi r30,lo8(C.43.3034)
	ldi r31,hi8(C.43.3034)
	ldi r24,lo8(6)
.L33:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC0)
	ldi r27,hi8(PinC0)
	ldi r30,lo8(C.44.3035)
	ldi r31,hi8(C.44.3035)
	ldi r24,lo8(3)
.L34:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC1)
	ldi r27,hi8(PinC1)
	ldi r30,lo8(C.45.3036)
	ldi r31,hi8(C.45.3036)
	ldi r24,lo8(3)
.L35:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC2)
	ldi r27,hi8(PinC2)
	ldi r30,lo8(C.46.3037)
	ldi r31,hi8(C.46.3037)
	ldi r24,lo8(3)
.L36:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC3)
	ldi r27,hi8(PinC3)
	ldi r30,lo8(C.47.3038)
	ldi r31,hi8(C.47.3038)
	ldi r24,lo8(3)
.L37:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC4)
	ldi r27,hi8(PinC4)
	ldi r30,lo8(C.48.3039)
	ldi r31,hi8(C.48.3039)
	ldi r24,lo8(3)
.L38:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC5)
	ldi r27,hi8(PinC5)
	ldi r30,lo8(C.49.3040)
	ldi r31,hi8(C.49.3040)
	ldi r24,lo8(3)
.L39:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC6)
	ldi r27,hi8(PinC6)
	ldi r30,lo8(C.50.3041)
	ldi r31,hi8(C.50.3041)
	ldi r24,lo8(3)
.L40:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinC7)
	ldi r27,hi8(PinC7)
	ldi r30,lo8(C.51.3042)
	ldi r31,hi8(C.51.3042)
	ldi r24,lo8(3)
.L41:
	ld r0,Z+
	st X+,r0
...
.LM30:
	ldi r26,lo8(PortD)
	ldi r27,hi8(PortD)
	ldi r30,lo8(C.52.3043)
	ldi r31,hi8(C.52.3043)
	ldi r24,lo8(6)
.L42:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD0)
	ldi r27,hi8(PinD0)
	ldi r30,lo8(C.53.3044)
	ldi r31,hi8(C.53.3044)
	ldi r24,lo8(3)
.L43:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD1)
	ldi r27,hi8(PinD1)
	ldi r30,lo8(C.54.3045)
	ldi r31,hi8(C.54.3045)
	ldi r24,lo8(3)
.L44:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD2)
	ldi r27,hi8(PinD2)
	ldi r30,lo8(C.55.3046)
	ldi r31,hi8(C.55.3046)
	ldi r24,lo8(3)
.L45:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD3)
	ldi r27,hi8(PinD3)
	ldi r30,lo8(C.56.3047)
	ldi r31,hi8(C.56.3047)
	ldi r24,lo8(3)
.L46:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD4)
	ldi r27,hi8(PinD4)
	ldi r30,lo8(C.57.3048)
	ldi r31,hi8(C.57.3048)
	ldi r24,lo8(3)
.L47:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD5)
	ldi r27,hi8(PinD5)
	ldi r30,lo8(C.58.3049)
	ldi r31,hi8(C.58.3049)
	ldi r24,lo8(3)
.L48:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD6)
	ldi r27,hi8(PinD6)
	ldi r30,lo8(C.59.3050)
	ldi r31,hi8(C.59.3050)
	ldi r24,lo8(3)
.L49:
	ld r0,Z+
	st X+,r0
	...
	ldi r26,lo8(PinD7)
	ldi r27,hi8(PinD7)
	ldi r30,lo8(C.60.3051)
	ldi r31,hi8(C.60.3051)
	ldi r24,lo8(3)
.L50:
	ld r0,Z+
	st X+,r0
...
.LM63:
	ldi r26,lo8(RedLeds)
	ldi r27,hi8(RedLeds)
	ldi r30,lo8(C.19.3009)
	ldi r31,hi8(C.19.3009)
	ldi r24,lo8(3)
.L89:
	ld r0,Z+
	st X+,r0
...
.LM64:
	...
	ldi r30,lo8(C.20.3010)
	ldi r31,hi8(C.20.3010)
	ldi r24,lo8(3)
.L90:
	ld r0,Z+
	st X+,r0
...
.LM65:
	...
	ldi r30,lo8(C.21.3011)
	ldi r31,hi8(C.21.3011)
	ldi r24,lo8(3)
.L91:
	ld r0,Z+
	st X+,r0
...
.LM66:
	...
	ldi r30,lo8(C.22.3012)
	ldi r31,hi8(C.22.3012)
	ldi r24,lo8(3)
.L92:
	ld r0,Z+
	st X+,r0
...
.LM67:
	...
	ldi r30,lo8(C.23.3013)
	ldi r31,hi8(C.23.3013)
	ldi r24,lo8(3)
.L93:
	ld r0,Z+
	st X+,r0
...
.LM68:
	ldi r26,lo8(AllLeds)
	ldi r27,hi8(AllLeds)
	ldi r30,lo8(C.24.3014)
	ldi r31,hi8(C.24.3014)
	ldi r24,lo8(3)
.L94:
	ld r0,Z+
	st X+,r0
...
.LM83:
	...
	call initButton
.LM84:
	sts ButtonSwitch,__zero_reg__
	ldi r24,lo8(PinA5)
	ldi r25,hi8(PinA5)
	sts ButtonSwitch+1+1,r25
	sts ButtonSwitch+1,r24
	ldi r24,lo8(ButtonSwitch)
	ldi r25,hi8(ButtonSwitch)
	call initButton
/* epilogue start */
.LM85:
	ret
...
.LM150:
	ldi r26,lo8(Timer0)
	ldi r27,hi8(Timer0)
	ldi r30,lo8(C.0.2920)
	ldi r31,hi8(C.0.2920)
	ldi r24,lo8(7)
.L159:
	ld r0,Z+
	st X+,r0
...
.LM151:
	ldi r26,lo8(Timer1)
	ldi r27,hi8(Timer1)
	ldi r30,lo8(C.1.2921)
	ldi r31,hi8(C.1.2921)
	ldi r24,lo8(7)
.L160:
	ld r0,Z+
	st X+,r0
...
.LM152:
	ldi r26,lo8(Timer2)
	ldi r27,hi8(Timer2)
	ldi r30,lo8(C.2.2922)
	ldi r31,hi8(C.2.2922)
	ldi r24,lo8(7)
.L161:
	ld r0,Z+
	st X+,r0
...
.LM153:
	ldi r26,lo8(Timer3)
	ldi r27,hi8(Timer3)
	ldi r30,lo8(C.3.2923)
	ldi r31,hi8(C.3.2923)
	ldi r24,lo8(7)
.L162:
	ld r0,Z+
	st X+,r0
...
.LM154:
	ldi r26,lo8(Timer0A)
	ldi r27,hi8(Timer0A)
	ldi r30,lo8(C.4.2924)
	ldi r31,hi8(C.4.2924)
	ldi r24,lo8(8)
.L163:
	ld r0,Z+
	st X+,r0
...
.LM155:
	ldi r26,lo8(Timer0B)
	ldi r27,hi8(Timer0B)
	ldi r30,lo8(C.5.2925)
	ldi r31,hi8(C.5.2925)
	ldi r24,lo8(8)
.L164:
	ld r0,Z+
	st X+,r0
...
.LM156:
	ldi r26,lo8(Timer1A)
	ldi r27,hi8(Timer1A)
	ldi r30,lo8(C.6.2926)
	ldi r31,hi8(C.6.2926)
	ldi r24,lo8(8)
.L165:
	ld r0,Z+
	st X+,r0
...
.LM157:
	ldi r26,lo8(Timer1B)
	ldi r27,hi8(Timer1B)
	ldi r30,lo8(C.7.2927)
	ldi r31,hi8(C.7.2927)
	ldi r24,lo8(8)
.L166:
	ld r0,Z+
	st X+,r0
...
.LM158:
	ldi r26,lo8(Timer2A)
	ldi r27,hi8(Timer2A)
	ldi r30,lo8(C.8.2928)
	ldi r31,hi8(C.8.2928)
	ldi r24,lo8(8)
.L167:
	ld r0,Z+
	st X+,r0
...
.LM159:
	ldi r26,lo8(Timer2B)
	ldi r27,hi8(Timer2B)
	ldi r30,lo8(C.9.2929)
	ldi r31,hi8(C.9.2929)
	ldi r24,lo8(8)
.L168:
	ld r0,Z+
	st X+,r0
...
.LM160:
	ldi r26,lo8(Timer3A)
	ldi r27,hi8(Timer3A)
	ldi r30,lo8(C.10.2930)
	ldi r31,hi8(C.10.2930)
	ldi r24,lo8(8)
.L169:
	ld r0,Z+
	st X+,r0
...
.LM161:
	ldi r26,lo8(Timer3B)
	ldi r27,hi8(Timer3B)
	ldi r30,lo8(C.11.2931)
	ldi r31,hi8(C.11.2931)
	ldi r24,lo8(8)
.L170:
	ld r0,Z+
	st X+,r0
...
C.0.2920:
	...
	.word	69
	.word	110
	.type	C.24.3014, @object
	.size	C.24.3014, 3
C.24.3014:
	.word	allLedsArray
	.byte	15
	.type	C.23.3013, @object
	.size	C.23.3013, 3
C.23.3013:
	.word	middleLedsArray
	.byte	5
	.type	C.22.3012, @object
	.size	C.22.3012, 3
C.22.3012:
	.word	greenLedsArray
	.byte	3
	.type	C.21.3011, @object
	.size	C.21.3011, 3
C.21.3011:
	.word	whiteLedsArray
	.byte	5
	.type	C.20.3010, @object
	.size	C.20.3010, 3
C.20.3010:
	.word	yellowLedsArray
	.byte	2
	.type	C.19.3009, @object
	.size	C.19.3009, 3
C.19.3009:
	.word	redLedsArray
	.byte	5
	.type	C.60.3051, @object
	.size	C.60.3051, 3
C.60.3051:
	.word	PortD
	.byte	-128
	.type	C.59.3050, @object
	.size	C.59.3050, 3
C.59.3050:
	.word	PortD
	.byte	64
	.type	C.58.3049, @object
	.size	C.58.3049, 3
C.58.3049:
	.word	PortD
	.byte	32
	.type	C.57.3048, @object
	.size	C.57.3048, 3
C.57.3048:
	.word	PortD
	.byte	16
	.type	C.56.3047, @object
	.size	C.56.3047, 3
C.56.3047:
	.word	PortD
	.byte	8
	.type	C.55.3046, @object
	.size	C.55.3046, 3
C.55.3046:
	.word	PortD
	.byte	4
	.type	C.54.3045, @object
	.size	C.54.3045, 3
C.54.3045:
	.word	PortD
	.byte	2
	.type	C.53.3044, @object
	.size	C.53.3044, 3
C.53.3044:
	.word	PortD
	.byte	1
	.type	C.52.3043, @object
	.size	C.52.3043, 6
C.52.3043:
	.word	43
	.word	41
	.word	42
	.type	C.51.3042, @object
	.size	C.51.3042, 3
C.51.3042:
	.word	PortC
	.byte	-128
	.type	C.50.3041, @object
	.size	C.50.3041, 3
C.50.3041:
	.word	PortC
	.byte	64
	.type	C.49.3040, @object
	.size	C.49.3040, 3
C.49.3040:
	.word	PortC
	.byte	32
	.type	C.48.3039, @object
	.size	C.48.3039, 3
C.48.3039:
	.word	PortC
	.byte	16
	.type	C.47.3038, @object
	.size	C.47.3038, 3
C.47.3038:
	.word	PortC
	.byte	8
	.type	C.46.3037, @object
	.size	C.46.3037, 3
C.46.3037:
	.word	PortC
	.byte	4
	.type	C.45.3036, @object
	.size	C.45.3036, 3
C.45.3036:
	.word	PortC
	.byte	2
	.type	C.44.3035, @object
	.size	C.44.3035, 3
C.44.3035:
	.word	PortC
	.byte	1
	.type	C.43.3034, @object
	.size	C.43.3034, 6
C.43.3034:
	.word	40
	.word	38
	.word	39
	.type	C.42.3033, @object
	.size	C.42.3033, 3
C.42.3033:
	.word	PortB
	.byte	-128
	.type	C.41.3032, @object
	.size	C.41.3032, 3
C.41.3032:
	.word	PortB
	.byte	64
	.type	C.40.3031, @object
	.size	C.40.3031, 3
C.40.3031:
	.word	PortB
	.byte	32
	.type	C.39.3030, @object
	.size	C.39.3030, 3
C.39.3030:
	.word	PortB
	.byte	16
	.type	C.38.3029, @object
	.size	C.38.3029, 3
C.38.3029:
	.word	PortB
	.byte	8
	.type	C.37.3028, @object
	.size	C.37.3028, 3
C.37.3028:
	.word	PortB
	.byte	4
	.type	C.36.3027, @object
	.size	C.36.3027, 3
C.36.3027:
	.word	PortB
	.byte	2
	.type	C.35.3026, @object
	.size	C.35.3026, 3
C.35.3026:
	.word	PortB
	.byte	1
	.type	C.34.3025, @object
	.size	C.34.3025, 6
C.34.3025:
	.word	37
	.word	35
	.word	36
	.type	C.33.3024, @object
	.size	C.33.3024, 3
C.33.3024:
	.word	PortA
	.byte	-128
	.type	C.32.3023, @object
	.size	C.32.3023, 3
C.32.3023:
	.word	PortA
	.byte	64
	.type	C.31.3022, @object
	.size	C.31.3022, 3
C.31.3022:
	.word	PortA
	.byte	32
	.type	C.30.3021, @object
	.size	C.30.3021, 3
C.30.3021:
	.word	PortA
	.byte	16
	.type	C.29.3020, @object
	.size	C.29.3020, 3
C.29.3020:
	.word	PortA
	.byte	8
	.type	C.28.3019, @object
	.size	C.28.3019, 3
C.28.3019:
	.word	PortA
	.byte	4
	.type	C.27.3018, @object
	.size	C.27.3018, 3
C.27.3018:
	.word	PortA
	.byte	2
	.type	C.26.3017, @object
	.size	C.26.3017, 3
C.26.3017:
	.word	PortA
	.byte	1
	.type	C.25.3016, @object
	.size	C.25.3016, 6
C.25.3016:
	.word	34
	.word	32
