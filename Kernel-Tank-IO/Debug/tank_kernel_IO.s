...
.LM37:
	ldi r26,lo8(PortA_)
	ldi r27,hi8(PortA_)
	ldi r30,lo8(C.66.4298)
	ldi r31,hi8(C.66.4298)
	ldi r24,lo8(6)
.L18:
	ld r0,Z+
	st X+,r0
...
.LM38:
	ldi r26,lo8(PortB_)
	ldi r27,hi8(PortB_)
	ldi r30,lo8(C.67.4299)
	ldi r31,hi8(C.67.4299)
	ldi r24,lo8(6)
.L19:
	ld r0,Z+
	st X+,r0
...
.LM39:
	ldi r26,lo8(PortC_)
	ldi r27,hi8(PortC_)
	ldi r30,lo8(C.68.4300)
	ldi r31,hi8(C.68.4300)
	ldi r24,lo8(6)
.L20:
	ld r0,Z+
	st X+,r0
...
.LM40:
	ldi r26,lo8(PortD_)
	ldi r27,hi8(PortD_)
	ldi r30,lo8(C.69.4301)
	ldi r31,hi8(C.69.4301)
	ldi r24,lo8(6)
.L21:
	ld r0,Z+
	st X+,r0
...
.LM73:
	...
	ldi r30,lo8(C.60.4291)
	ldi r31,hi8(C.60.4291)
	ldi r24,lo8(3)
.L28:
	ld r0,Z+
	st X+,r0
...
.LM74:
	...
	ldi r30,lo8(C.61.4292)
	ldi r31,hi8(C.61.4292)
	ldi r24,lo8(3)
.L29:
	ld r0,Z+
	st X+,r0
...
.LM75:
	...
	ldi r30,lo8(C.62.4293)
	ldi r31,hi8(C.62.4293)
	ldi r24,lo8(3)
.L30:
	ld r0,Z+
	st X+,r0
...
.LM76:
	...
	ldi r30,lo8(C.63.4294)
	ldi r31,hi8(C.63.4294)
	ldi r24,lo8(3)
.L31:
	ld r0,Z+
	st X+,r0
...
.LM77:
	...
	ldi r30,lo8(C.64.4295)
	ldi r31,hi8(C.64.4295)
	ldi r24,lo8(3)
.L32:
	ld r0,Z+
	st X+,r0
...
.LM78:
	...
	ldi r30,lo8(C.65.4296)
	ldi r31,hi8(C.65.4296)
	ldi r24,lo8(3)
.L33:
	ld r0,Z+
	st X+,r0
...
.LM97:
	ldi r26,lo8(Timer0_)
	ldi r27,hi8(Timer0_)
	ldi r30,lo8(C.29.4228)
	ldi r31,hi8(C.29.4228)
	ldi r24,lo8(7)
.L47:
	ld r0,Z+
	st X+,r0
...
.LM98:
	ldi r26,lo8(Timer1_)
	ldi r27,hi8(Timer1_)
	ldi r30,lo8(C.30.4229)
	ldi r31,hi8(C.30.4229)
	ldi r24,lo8(7)
.L48:
	ld r0,Z+
	st X+,r0
...
.LM99:
	ldi r26,lo8(Timer2_)
	ldi r27,hi8(Timer2_)
	ldi r30,lo8(C.31.4230)
	ldi r31,hi8(C.31.4230)
	ldi r24,lo8(7)
.L49:
	ld r0,Z+
	st X+,r0
...
.LM100:
	ldi r26,lo8(Timer3_)
	ldi r27,hi8(Timer3_)
	ldi r30,lo8(C.32.4231)
	ldi r31,hi8(C.32.4231)
	ldi r24,lo8(7)
.L50:
	ld r0,Z+
	st X+,r0
...
C.29.4228:
	...
	.word	69
	.word	110
	.type	C.65.4296, @object
	.size	C.65.4296, 3
C.65.4296:
	.word	allLedsArray
	.byte	15
	.type	C.64.4295, @object
	.size	C.64.4295, 3
C.64.4295:
	.word	middleLedsArray
	.byte	5
	.type	C.63.4294, @object
	.size	C.63.4294, 3
C.63.4294:
	.word	greenLedsArray
	.byte	3
	.type	C.62.4293, @object
	.size	C.62.4293, 3
C.62.4293:
	.word	whiteLedsArray
	.byte	5
	.type	C.61.4292, @object
	.size	C.61.4292, 3
C.61.4292:
	.word	yellowLedsArray
	.byte	2
	.type	C.60.4291, @object
	.size	C.60.4291, 3
C.60.4291:
	.word	redLedsArray
	.byte	5
	.type	C.69.4301, @object
	.size	C.69.4301, 6
C.69.4301:
	.word	43
	.word	41
	.word	42
	.type	C.68.4300, @object
	.size	C.68.4300, 6
C.68.4300:
	.word	40
	.word	38
	.word	39
	.type	C.67.4299, @object
	.size	C.67.4299, 6
C.67.4299:
	.word	37
	.word	35
	.word	36
	.type	C.66.4298, @object
	.size	C.66.4298, 6
C.66.4298:
	.word	34
	.word	32
