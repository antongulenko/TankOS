...
.Ltext0:
	...
	.uleb128 0x74
	.ascii	"DEF"
	.string	"INE_TIMER_CONFIG(configName) extern const PTimerPair configName;"
	.byte	0x1
	.uleb128 0x76
	.string	"DEFINE_TIMER(timerName) extern const PTimer timerName;"
	.byte	0x4
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x23
	...
	.byte	0x1
	.uleb128 0x15c
	.ascii	"fdev_setup_stream(stream,p,g,f) do { (stream)->put = p; (str"
	.ascii	"eam"
	.string	")->get = g; (stream)->flags = f; (stream)->udata = 0; } while(0)"
	.byte	0x1
	.uleb128 0x165
	...
	.uleb128 0x183
	.ascii	"FDEV_SET"
	.string	"UP_STREAM(p,g,f) { .put = p, .get = g, .flags = f, .udata = 0, }"
	.byte	0x1
	.uleb128 0x1c0
	...
	.byte	0x1
	.uleb128 0xa
	.string	"delay(a) _delay_ms(a)"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x30
	.byte	0x1
	.uleb128 0x1
	.string	"smily_width 16"
	.byte	0x1
	.uleb128 0x2
	.string	"smily_height 16"
	.byte	0x4
	.byte	0x4
	.byte	0x4
/* #APP */
	__RAMPZ__ = 0x3b
/* #NOAPP */
	.section	.text.plot_smily,"ax",@progbits
.global	plot_smily
	.type	plot_smily, @function
plot_smily:
.LFB5:
.LSM0:
.LVL0:
...
.LSM2:
	ldi r24,lo8(16)
	ldi r22,lo8(16)
	ldi r20,lo8(smily_bits)
	ldi r21,hi8(smily_bits)
	call bgx1_drawBitmap_P
/* epilogue start */
.LSM3:
	ret
.LFE5:
	.size	plot_smily, .-plot_smily
	.section	.text.plot_house,"ax",@progbits
.global	plot_house
	.type	plot_house, @function
plot_house:
.LFB6:
.LSM4:
.LVL2:
...
.LVL15:
	...
	ret
.LFE6:
	.size	plot_house, .-plot_house
	.section	.text.plot_vLines,"ax",@progbits
.global	plot_vLines
	.type	plot_vLines, @function
plot_vLines:
.LFB7:
.LSM22:
.LVL16:
...
.LVL21:
	...
	ret
.LFE7:
	.size	plot_vLines, .-plot_vLines
	.section	.text.plot_hLines,"ax",@progbits
.global	plot_hLines
	.type	plot_hLines, @function
plot_hLines:
.LFB8:
.LSM36:
.LVL22:
...
.LSM53:
/* #APP */
 ;  87 "../../Main/device_tests/Main_bgx1_gfx.c.h" 1
	sei
 ;  0 "" 2
.LVL28:
/* #NOAPP */
...
.LASLTP0:
	...
	.ascii	"../../Main"
	.byte	0
	.ascii	"../../Main/device_tests"
	.byte	0
	.ascii	"../../Main/device_tests/res"
	.byte	0
	.ascii	"..\\..\\AntonAvrLib"
	.byte	0
	...
	.ascii	"..\\..\\AntonAvrLib/kernel/processes/mutex/../../.."
	.byte	0
	.ascii	"..\\..\\Kernel-NIBObee"
	.byte	0
	.ascii	"..\\..\\Kernel-NIBObee/shared"
	.byte	0
