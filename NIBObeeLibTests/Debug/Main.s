...
.Ltext0:
	...
	.byte	0x1
	.uleb128 0x28
	.string	"NIBOBEE_I2CMASTER_H_ "
	.byte	0x1
	.uleb128 0x30
	.string	"I2C_BUF_SIZE 0x25"
	.byte	0x1
	.uleb128 0x31
	.string	"NIBO_I2C_TXRX 1"
	.byte	0x1
	.uleb128 0x32
	.string	"I2C_TWBR_INIT 100"
	.byte	0x1
	.uleb128 0x71
	.string	"I2C_TX(ADDR) ((ADDR)<<1)"
	.byte	0x1
	.uleb128 0x72
	.string	"I2C_RX(ADDR) (((ADDR)<<1)+1)"
	.byte	0x4
	.byte	0x3
	.uleb128 0x5
	.uleb128 0x12
...
.LSM15:
/* #APP */
 ;  42 "..\..\..\NIBObeeLib\src/examples/bgx1_test_io/bgx1_test_io.c" 1
	sei
 ;  0 "" 2
.LSM16:
/* #NOAPP */
...
.L3:
.LSM25:
	sts bgx1_DDR,__zero_reg__
.LSM26:
	sts bgx1_PORT,__zero_reg__
.LSM27:
...
.LASLTP0:
	...
	.byte	0
	.ascii	"..\\..\\..\\NIBObeeLib\\src/examples/bgx1_test_io"
	.byte	0
...
.LASF15:
	.string	"temp"
.LASF23:
	.string	"C:\\\\Dev\\\\NIBObee\\\\NIBObee\\\\NIBObeeLibTests\\\\Debug"
.LASF22:
	.string	".././Main.c"
.LASF19:
	.string	"bgx1_Leds"
